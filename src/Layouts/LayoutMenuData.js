...
const Navdata = () => {
  ...
  const [isDirectories, setIsDirectories] = useState(false);
  ...
  let [isgdm, setIsgdm] = useState(false);
  // Apps
  ...
  useEffect(() => {
    ...
    if (iscurrentState !== "Analitic") {
      setIsAnalitics(false);
    }
    if (iscurrentState !== "Directory") {
      setIsDirectories(false);
    }
  ...
  const menuItems = [
    ...
    {
      id: "hidromodel",
      label: t("Hydrodynamic modeling"),
      // link: "/hydromodeling",

      icon: "bx bx-file",
      link: "/#",
      stateVariables: isgdm,
      click: function (e) {
        e.preventDefault();
        setIsgdm(!isgdm);
        setIscurrentState("Analitic");
        updateIconSidebar(e);
      },
      subItems: [
        {
    ...
    },
    {
      ...
      link: "/#",
      stateVariables: isAnalitics,
      click: function (e) {
        e.preventDefault();
        setIsAnalitics(!isAnalitics);
        setIscurrentState("Analitic");
        updateIconSidebar(e);
      },
      subItems: [
    ...
    },
    {
      ...
      icon: "bx bx-list-ul",
      link: "/#",
      stateVariables: isDirectories,
      click: function (e) {
        e.preventDefault();
        setIsDirectories(!isDirectories);
