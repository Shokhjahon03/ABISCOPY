...
const FormValidations = () => {
  ...
  document.title = "Form Validation | ABMC SCADA - Kibera Technology";
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    different style of feedback.While these feedback styles
                    cannot be styled with CSS, you can still customize the
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>&lt;form&gt;</code>. This disables the browser default
                    feedback tooltips, but still provides access to the form
                    validation APIs in JavaScript. Try to submit the form below;
                    our JavaScript will intercept the submit button and relay
                    feedback to you. When attempting to submit, you’ll see the{" "}
                    <code>:invalid</code> and <code>:valid</code> styles applied
