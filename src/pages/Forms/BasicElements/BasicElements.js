...
const BasicElements = () => {
  document.title = "Basic Elements | ABMC SCADA - Kibera Technology";
              ...
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>form-control-lg</code> class to set large size
                    input and Use <code>form-control-sm</code> class to set
                    small size input. No class is needed for default size input.
                  </p>
                  <div className="live-preview">
                  ...
                  <div className="live-preview">
                    <div>
                      <p className="text-muted">
                        ...
                        <code>form-check-input</code> when there’s no visible
                      ...
                      <Row className="g-3">
                        ...
                        <Col lg={12}>
                          <UncontrolledDropdown className="input-group">
                            ...
                            <DropdownMenu>
                              <li>
                                <DropdownItem>Action before</DropdownItem>
                              </li>
                              <li>
                                <DropdownItem>
