...
const CheckBoxAndRadio = () => {
  document.title = "Checkbox & Radio | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>type="checkbox"</code> attribute to set a
                            checkbox and add <code>defaultChecked</code>{" "}
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute to set a
                            checkbox disabled and add{" "}
                            <code>defaultChecked</code> attribute to set a
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>form-check-right</code> class to
                            form-check class to set a checkbox on the right
                            side.
                          </p>
                          <div className="form-check form-check-right mb-2">
                            <Input
                          ...
                          <div>
                            <div className="form-check form-check-right">
                              ...
                              <Label
                                className="form-check-label"
                                htmlFor="flexCheckCheckedRightDisabled"
                              >
                                Disabled checked checkbox
                              </Label>
                            </div>
                        ...
                        <div className="mt-3">
                          ...
                          <div>
                            <div className="form-check">
                              ...
                              <Label
                                className="form-check-label"
                                htmlFor="defaultIndeterminateCheck"
                              >
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col md={6}>
                        <div>
                          <p className="text-muted">
                            ...
                            below-mentioned color variation to set a color
                            checkbox.
                          </p>
                          <div>
                      ...
                      <Col md={6}>
                        <div className="mt-4 mt-md-0">
                          <p className="text-muted">
                            Use <code>form-check-outline</code> class and{" "}
                            <code>form-check-</code> class with below-mentioned
                            color variation to set a color checkbox with
                            outline.
                          </p>
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>type="radio"</code> attribute to set a
                            radio button and add <code>defaultChecked</code>{" "}
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>disabled</code> attribute to set a radio
                            button disabled and add <code>defaultChecked</code>{" "}
                            attribute to set a radio checked by default.
                          </p>
                          <div className="form-check mb-2">
                            <Input
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>form-check-right</code> class to
                            form-check class to set a radio button on the right
                            side.
                          </p>
                          <div className="form-check form-check-right mb-2">
                            <Input
                      ...
                      <Col md={6}>
                        <div className="mt-4 mt-md-0">
                          <p className="text-muted">
                            Use <code>form-check-outline</code> class and{" "}
                            <code>form-check-</code> class with below-mentioned
                            color variation to set a color radio with outline.
                          </p>
                    ...
                    <Row>
                      <Col lg={4} md={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>form-switch</code> class to form-check
                            class to set a switch and add{" "}
                            <code>defaultChecked</code> attribute to set a
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <div className="form-check form-switch">
                            ...
                            <Label
                              className="form-check-label"
                              htmlFor="flexSwitchCheckCheckedDisabled1"
                            >
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-4 mt-md-0">
                          ...
                          <p className="text-muted">
                            Use <code>form-check-right</code> class to
                            form-check class to set a switch button on the right
                            side.
                          </p>
                          <div>
                            <div className="form-check form-switch form-check-right mb-2">
                              ...
                              <Label
                                className="form-check-label"
                                htmlFor="flexSwitchCheckRightDisabled"
                              >
                                Switch Right input
                              </Label>
                            </div>
                      ...
                      <Col lg={4} md={6}>
                        <div className="mt-3">
                          ...
                          <p className="text-muted">
                            Use <code>form-switch-md</code> class to set a
                            medium size switch button and
                            <code>form-switch-lg</code> class to form-check
                            class to set a large size switch button
                            respectively. No such class is required for small
                            size switch button.
                          </p>
            ...
            <div className="col-12">
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>form-check-</code> class with below-mentioned
          ...
          <Row>
            <div className="col-12">
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>form-switch-custom</code> class &amp;{" "}
                    <code>form-switch-</code> class with below-mentioned color
                    variation to set a color radius.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col md={6}>
          ...
          <Row>
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>form-check-inline</code> class to form-check class
                    to set horizontally align checkboxes, radios, or switches.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col lg={4}>
          ...
          <Row>
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Omit the wrapping, <code>form-check</code> class for
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>btn</code> styles rather than form-check-label class
                    on the &lt;label&gt; elements. These toggle buttons can
                    further be grouped in a{" "}
                    <a href="https://getbootstrap.com/docs/5.1/components/button-group/">
                      button group
                    </a>{" "}
                    if needed.
                  </p>
            ...
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Different variants of <code>btn</code> attribute, such as
                    the various outlined styles, are supported.
                  </p>
                  <div className="live-preview">
                    <div className="hstack gap-2 flex-wrap">
                      <Input
