...
const Formlayouts = () => {
  document.title = "Form Layout | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    By adding{" "}
                    <Link
                      to="/docs/5.1/layout/gutters/"
                      className="text-decoration-underline"
                    >
                      gutter modifier classes
                    </Link>
                    , you can have control over the gutter width in as well the
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>col-form-label-sm</code> class to set small size
                    form label or <code>col-form-label-lg</code> class to set
                    large size form label to &lt;label&gt;. No such class is
            ...
            <Col lg={12}>
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>sm={`required size`}</code> size value to set
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>row-cols-*</code> class to set form inline.
                  </p>
                  <div className="live-preview">
                    <Form action="#">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>form-floating</code> class to enable floating
                      ...
                      <Row className="g-3">
                        ...
                        <Col lg={4}>
                          <div className="form-floating">
                            <Input
                              ...
                              placeholder="Enter your email"
                            />
                            <Label htmlFor="emailfloatingInput">
                              Email Address
                            </Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            ...
                            />
                            <Label htmlFor="passwordfloatingInput">
                              Password
                            </Label>
                          </div>
                        </Col>
                        <Col lg={4}>
                          <div className="form-floating">
                            <Input
                              ...
                              placeholder="Confirm password"
                            />
                            <Label htmlFor="passwordfloatingInput1">
                              Confirm Password
                            </Label>
                          </div>
                        </Col>
