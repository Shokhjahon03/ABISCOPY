...
const BasicTables = () => {
  document.title = "Basic Tables | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                <PreviewCardHeader title="Default Table" />
                <CardBody>
                  <p className="text-muted">
                    Use <code>Table</code> attribute to show bootstrap-based
                    default table.
                  </p>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-striped</code> class to add zebra-striping
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-4">
                    Use .<code>table-striped-columns</code> to add
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-dark</code> class to set dark color table
                    body and <code>table-success</code> class to set success
                    color table body respectively. use <code>table-</code> class
                    with different color variation to set required table body
                    color.
                  </p>
                  <div className="live-preview">
                    <Row>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-hover</code> class to enable a hover state
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-4">
                    Use <code>table-card</code> class to show card-based table
                    within a &lt;tbody&gt;.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive table-card">
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-active</code> class to highlight a table row
                    or cell.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-bordered</code> class to show borders on all
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>border-</code> class with color variation class to
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-borderless</code> to set a table without
                    borders.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
          ...
          <Row>
            <Col xl="6">
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-sm</code> class to create any table more
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>table-light</code> or <code>table-dark</code>{" "}
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Add <code>&lt;tbody&gt;</code> attribute to group footer
            ...
            <Col xl={6}>
              <div className="card">
                ...
                <CardBody>
                  <p className="text-muted">
                    You can also put the <code>&lt;caption&gt;</code> attribute
                    on the top of the table with <code>caption-top</code> class.
                  </p>
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Example of basic table nesting. Border styles, active
                    styles, and table variants are not inherited by nested
                    tables.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
            ...
            <Col xl={6}>
              <Card>
                ...
                <div className="card-body">
                  <p className="text-muted">
                    Use <code>table-</code> class with below-mentioned color
                    variation class within &lt;tr&gt; to set color on table row.
                  </p>
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Table cells of <code>&lt;thead&gt;</code> are always
                    vertical aligned to the bottom. Table cells in{" "}
                    <code>&lt;tbody&gt;</code> inherit their alignment from{" "}
                    <code>&lt;table&gt;</code> and are aligned to the the top by
                    default. Use the vertical align classes to re-align where
                    needed.
                  </p>
                  <div className="live-preview">
                    <div className="table-responsive">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              ...
                              the preceding cells. Use the vertical align
                              classes to re-align where needed. inherit their
                              alignment from and are aligned to the the top by
                              default.
                            </td>
                          </tr>
