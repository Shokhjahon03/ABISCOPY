...
const Faqs = () => {
  ...
  document.title = "FAQs | ABMC SCADA - Kibera Technology";
                      ...
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={col1} className="accordion-collapse">
                          <div className="accordion-body">
                            ...
                            existing European languages. It will be as simple
                      ...
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={col2} className="accordion-collapse">
                          <div className="accordion-body">
                            ...
                            of mine told me what Occidental is.
                          </div>
                        </Collapse>
                      </div>
                      <div className="accordion-item">
                        ...
                        <Collapse isOpen={col3} className="accordion-collapse">
                          <div className="accordion-body">
                            he wise man therefore always holds in these matters
                            to this principle of selection: he rejects pleasures
                            to secure other greater pleasures, or else he
                            endures pains to avoid worse pains.But I must
