...
const SiteMap = () => {
  document.title = "SiteMap | ABMC SCADA - Kibera Technology";
  return (
    <div>
                              ...
                              <ul className="departments">
                                ...
                                <li className="department">
                                  ...
                                  <ul>
                                    ...
                                    <li>
                                      <Link to="#">
                                        <span>Connect Via Social Media</span>
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                ...
                                <li className="department">
                                  ...
                                  <ul>
                                    <li>
                                      <Link to="#">
                                        <span>General Travel</span>
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                                        <span>Helpth Concerns</span>
                                      </Link>
                                    </li>
                                    <li>
                                      <Link to="#">
                  ...
                  <Row>
                    <Col sm={6}>
                      <div className="verti-sitemap">
                        <ul className="mb-0">
                          <li className="p-0 parent-title">
                            <Link to="#" className="fw-medium fs-14">
                              Nancy Martino - Project Director
                            </Link>
                          </li>
                          <ul>
                            <li>
                              <Link to="#" className="fw-medium">
                                Erica Kernan - Team Leader
                              </Link>
                            ...
                            <li>
                              ...
                              <ul className="second-list">
                                <li>
                                  <Link to="#">Jordyn Jones - Designer</Link>
                                </li>
                                <li>
                                  <Link to="#">Ashlee Haney - Developer</Link>
                                </li>
                                <li>
                                  <Link to="#">
                                    Rashad Charles - BackEnd Developer
                                  </Link>
                                </li>
                                <li>
                                  <Link to="#">
                                    Walter Newman - Frontend Developer
                                  </Link>
                                </li>
                                <li>
                                  <Link to="#">Adam Moss - Designer</Link>
                                </li>
                              </ul>
                            </li>
                            <li>
                              <Link to="#" className="fw-medium">
                                Tilly Kent - Executive Manager
                              </Link>
                              <ul>
                                <li>
                                  <Link to="#">
                                    Tyler Porter - Account Executive
                                  </Link>
                                </li>
                                <li>
                                  <Link to="#">
                                    Alicia Thompson - Sales Executive
                                  </Link>
                                  <ul className="second-list">
                                    <li>
                                      <Link to="#">Jack Coates - Member</Link>
                                    </li>
                                    <li>
                                      <Link to="#">Owen Jarvis - Member</Link>
                                    </li>
                                    <li>
                                      <Link to="#">Ashlee Haney - Member</Link>
                                    </li>
                                    <li>
                                      <Link to="#">Archie Cook - Member</Link>
                                    </li>
                                  </ul>
                                </li>
                              </ul>
                      ...
                      <div className="verti-sitemap">
                        <ul className="mb-0">
                          ...
                          <ul>
                            ...
                            <li>
                              <Link to="#" className="fw-medium text-primary">
                                <i className="ri-pencil-ruler-2-line me-1 align-bottom"></i>{" "}
                                App Pages
                              </Link>
                              <ul className="second-list">
                                <li>
