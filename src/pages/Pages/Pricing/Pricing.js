...
const Pricing = () => {
  ...
  document.title = "Pricing | ABMC SCADA - Kibera Technology";
                  ...
                  <CardBody className="bg-light m-2 p-4">
                    ...
                    <ul className="list-unstyled vstack gap-3">
                      ...
                      <li>
                        <div className="d-flex">
                          <div
                            className={`flex-shrink-0 text-${price1.supportClass} me-1`}
                          >
                            <i
                              className={`ri-${price1.supportClassSymbol}-circle-fill fs-15 align-middle`}
                            ></i>
                          </div>
                          <div className="flex-grow-1">
                            <b>24/7</b> Support
                      ...
                      <li>
                        <div className="d-flex">
                          <div
                            className={`flex-shrink-0 text-${price1.storageClass} me-1`}
                          >
                            <i
                              className={`ri-${price1.storageClassSymbol}-circle-fill fs-15 align-middle`}
                            ></i>
                          </div>
                          <div className="flex-grow-1">
                      ...
                      <li>
                        <div className="d-flex">
                          <div
                            className={`flex-shrink-0 text-${price1.domainClass} me-1`}
                          >
                            <i
                              className={`ri-${price1.domainClassSymbol}-circle-fill fs-15 align-middle`}
                            ></i>
                          </div>
                    ...
                    <div className="mt-3 pt-2">
                      <Link
                        to="#"
                        className={`btn btn-${price1.planButtonClassname} ${price1.btnstatus} w-100`}
                      >
                        {price1.btntxt}
                      </Link>
                    </div>
