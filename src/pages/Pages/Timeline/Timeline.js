...
const Timeline = () => {
  ...
  document.title = "Timeline | ABMC SCADA - Kibera Technology";
                ...
                <div className="timeline">
                      ...
                      <div className="d-flex">
                        ...
                        <div className="flex-grow-1 ms-3">
                          ...
                          <p className="text-muted mb-2">
                            Wish someone a sincere ‘good luck in your new job’
                            with these sweet messages. Make sure you pick out a
                            good luck new job card to go with the words, and pop
                            a beautiful bunch of flowers from our gift range in
                            your basket, to make them feel super special.
                          </p>
                  ...
                  <div className="timeline-item right">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted fst-italic mb-2">
                        ...
                        project. Needs manual integration work of course but the
                  ...
                  <div className="timeline-item right">
                    ...
                    <div className="content">
                      ...
                      <p className="text-muted mb-2">
                        It is important for us that we receive email
                        notifications when a ticket is created as our IT staff
                        are mobile and will not always be looking at the
                        dashboard for new tickets.
                      </p>
                      <Link
                        to="#"
                            ...
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1 ms-3">
                                ...
                                <p className="text-muted mb-0">
                                  ...
                                  design. Increase or decrease the letter
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted">
                              In the trip planner, keep only one or two
                              activities in a day if the purpose of the trip is
                              to relax and take it easy during the vacation :
                            </p>
                            <Row className="border border-dashed rounded gx-2 p-2">
                              <Col xs={3}>
                                <Link to="#">
                        ...
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted mb-0">
                              ...
                              describe the significance of your findings in
                              light of what was already known about the research
                              problem being investigated, and to explain any new
                              understanding or fresh insights about the problem
                              after you've taken the findings into
                              consideration.
                            </p>
                          </div>
                        </div>
                      ...
                      <Col xs={12}>
                        <div className="timeline-box">
                          <div className="timeline-text">
                            ...
                            <p className="text-muted mb-0">
                              A client meeting, meaning, direct collaboration
                              and communication with a customer, is the best way
                              to understand their needs and how you can help
                              support them.
                            </p>
                          </div>
                        </div>
                    ...
                    <div className="swiper-wrapper">
                      ...
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">8 : 10 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">01 : 47 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">07 : 53 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">4 : 05 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">02 : 40 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">9 : 27 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                      <SwiperSlide>
                        <div className="card pt-2 border-0 item-box text-center">
                          ...
                          <div className="time">
                            <span className="badge bg-success">06 : 19 AM</span>
                          </div>
                        </div>
                      </SwiperSlide>
                    </div>
