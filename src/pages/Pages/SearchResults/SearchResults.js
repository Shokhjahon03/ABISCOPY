...
const SearchResults = () => {
  ...
  document.title = "Search Results | ABMC SCADA - Kibera Technology";
                ...
                <div>
                  <Nav className="nav-tabs nav-tabs-custom" role="tablist">
                    ...
                    <NavItem>
                      ...
                      >
                        <i className="ri-list-unordered text-muted align-bottom me-1"></i>{" "}
                        News
                      </NavLink>
                    </NavItem>
                    <NavItem>
                      ...
                      >
                        <i className="ri-video-line text-muted align-bottom me-1"></i>{" "}
                        Videos
                      </NavLink>
                    </NavItem>
                    <li className="nav-item ms-auto">
                      <Dropdown isOpen={dropdownOpen} toggle={toggledropDown}>
                        <DropdownToggle
                          className="nav-link fw-medium text-reset mb-n1"
                          role="button"
                        >
                ...
                <CardBody className="p-4">
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1">
                      <div className="pb-3">
                        ...
                        <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                          <li className="list-inline-item me-3">
                            <i className="ri-thumb-up-line align-middle me-1"></i>
                            10
                          </li>
                          <li className="list-inline-item me-3">
                      ...
                      <div className="py-3">
                        <h5 className="fs-13 mb-3 text-muted fst-italic">
                      ...
                      <div className="py-3">
                        ...
                        <p className="text-muted mb-2">
                          Skote is an admin dashboard template that is a
                          beautifully crafted, clean & minimal designed admin
                          template with Dark, Light Layouts with RTL options.
                          You can build any type of web application like Saas
                          based interface, eCommerce, Crypto, CRM, CMS, Project
                          management apps, Admin Panels, etc.
                        </p>
                        <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                          <li className="list-inline-item me-3">
                            <i className="ri-thumb-up-line align-middle me-1"></i>
                      ...
                      <div className="py-3">
                        ...
                        <p className="text-muted mb-2">
                          Minia react is a simple and beautiful admin template
                          built with Bootstrap ^5.1.3. It has{" "}
                          <span className="fw-semibold">
                            5+ different layouts and 3 modes
                          </span>{" "}
                          ( Dark, Light & RTL ) which are managed by SCSS only.
                          You can simply change to any layouts or mode by
                          changing a couple of lines code.
                        </p>
                        <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                          <li className="list-inline-item me-3">
                            <i className="ri-thumb-up-line align-middle me-1"></i>
                      ...
                      <div className="py-3">
                        ...
                        <p className="text-muted mb-2">
                          Dason is a simple and beautiful admin template built
                          with Bootstrap ^5.1.3. It has 5+ different layouts and
                          3 modes ( Dark, Light & RTL ) which are managed by
                          SCSS only. You can simply change to any layouts or
                          mode by changing a couple of lines code.
                        </p>
                        <ul className="list-inline d-flex align-items-center g-3 text-muted fs-14 mb-0">
                          <li className="list-inline-item me-3">
                            <i className="ri-thumb-up-line align-middle me-1"></i>
                                ...
                                <SwiperSlide key={key}>
                                  <div className="d-flex align-items-center border border-dashed rounded p-2">
                                    ...
                                    <div className="flex-grow-1 ms-2">
                                      <Link
                                        to="#"
                                        className="stretched-link fw-medium"
                                      >
                                        {item.title}
                                      </Link>
                                    </div>
                                ...
                                <div className="gallery-container">
                                  ...
                                  >
                                    ...
                                    <div className="gallery-overlay">
                                      <h5 className="overlay-caption fs-15">
                                        {item.title}
                                      </h5>
                                    </div>
                                  </Link>
                    ...
                    <TabPane tabId="3">
                                ...
                                <div className="d-sm-flex">
                                  ...
                                  <div className="flex-grow-1 ms-sm-4 mt-3 mt-sm-0">
                                    <ul className="list-inline mb-2">
                                      <li className="list-inline-item">
                                        <span
                                          className={`badge badge-soft-${item.badgeClass} fs-11`}
                                        >
                                          {item.badgeText}
                                        </span>
                                      </li>
                                    ...
                                    <ul className="list-inline mb-0">
                                      <li className="list-inline-item">
                                        <i className="ri-user-3-fill text-success align-middle me-1"></i>{" "}
                                        {item.auther}
                                      </li>
                                      <li className="list-inline-item">
                      ...
                      <Pagination
                        listClassName="justify-content-center"
                        className="pagination-separated mb-0 mt-4"
                      >
                        <PaginationItem disabled>
                          {" "}
                          <PaginationLink to="#">
