...
const VectorMaps = () => {
  document.title = "Vector Maps | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="usa-vectormap" style={{ height: "350px" }}>
                    <Vector value="us_aea" width="724" color="#6691e7" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="canada-vectormap" style={{ height: "350px" }}>
                    <Vector value="ca_lcc" width="500" color="#50c3e6" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="russia-vectormap">
                    <Vector value="ru_mill" width="500" color="#13c56b" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="spain-vectormap">
                    <Vector value="es_mill" width="500" color="#865ce2" />
                  </div>
                </CardBody>
              </Card>
            </Col>
