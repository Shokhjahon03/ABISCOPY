...
const LiveAuction = () => {
  document.title = "Live Auction | ABMC SCADA - Kibera Technology";
                      ...
                      <ul className="nav nav-pills filter-btns" role="tablist">
                        ...
                        <li className="nav-item" role="presentation">
                          <button
                            type="button"
                            data-filter="upto-15"
                            onClick={() => setCategory("upto-15")}
                            className={
                              displayCategory === "upto-15"
                                ? "nav-link fw-medium active"
                                : "nav-link fw-medium"
                            }
                          >
                        ...
                        <li className="nav-item" role="presentation">
                          <button
                            type="button"
                            data-filter="upto-30"
                            onClick={() => setCategory("upto-30")}
                            className={
                              displayCategory === "upto-30"
                                ? "nav-link fw-medium active"
                                : "nav-link fw-medium"
                            }
                          >
                        ...
                        <li className="nav-item" role="presentation">
                          <button
                            type="button"
                            data-filter="upto-40"
                            onClick={() => setCategory("upto-40")}
                            className={
                              displayCategory === "upto-40"
                                ? "nav-link fw-medium active"
                                : "nav-link fw-medium"
                            }
                          >
              ...
              <Row>
                <Col lg={12}>
                  <div className="text-center mb-3">
                    <button className="btn btn-link text-success mt-2">
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <img
                                  src={item.img}
                                  alt=""
                                  className="avatar-sm object-cover rounded-circle"
                                />
                                <div className="ms-2">
