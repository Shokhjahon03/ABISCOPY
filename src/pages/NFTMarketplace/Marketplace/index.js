...
const Marketplace = () => {
  document.title = "Marketplace | ABMC SCADA - Kibera Technology";
      ...
      <div className="page-content">
        <Container fluid>
          ...
          <Row>
            <Col xl={8}>
              <Row>
                {marketPlacewidget.map((item, key) => (
                      ...
                      <CardBody>
                        <Row className="g-1 mb-3">
                          {item.subItem.map((item, key) => (
                            <Col lg={6} key={key}>
                              {item.isChildren.map((item, key) => (
                                <img
                                  src={item.img}
                                  alt=""
                                  className={
                                    "img-fluid rounded " + item.imgClass
                                  }
                                  key={key}
                                />
                              ))}
            ...
            <Col xl={4}>
              ...
              >
                <CardBody className="p-4">
                  <span className="badge bg-info fw-medium mb-3 fs-12">
                    Trending Artwork
                  </span>
                  ...
                  <p className="text-white-75 mb-3">
                    Take advantage of the first text-based NFT. Select a text or
                    write your own and let it live forever on the Ethereum
                    blockchain you or future owners can add text to an existing
                    ChainText token..
                  </p>
                  <div className="hstack gap-2">
                    <Link to="/apps-nft-create" className="btn btn-success">
                      Create NFT
                    </Link>
                    <Link to="/apps-nft-explore" className="btn btn-danger">
                      Explore Now
                    </Link>
                  </div>
                </CardBody>
                  ...
                  <div className="marquee">
                    <div>
                      <span>
                        ...
                        unique in it's creative design and cannot be duplicated,
                        making them limited and rare. NFTs get their value
                        because the transaction proves ownership of the art.
                      </span>
                      <span>
                        NFT art is a digital asset that is collectable, unique,
                        and non-transferrable, Cortes explained. Every NFT is
            ...
            <Col lg={12}>
              <div className="d-lg-flex align-items-center mb-4">
                ...
                <div className="flex-shrink-0 mt-4 mt-lg-0">
                  <Link to="/apps-nft-explore" className="btn btn-soft-primary">
                    View All{" "}
                    <i className="ri-arrow-right-line align-bottom"></i>
                  </Link>
                </div>
                ...
                <Card>
                  ...
                  <CardBody className="text-center">
                    <img
                      src={item.img}
                      alt=""
                      className="avatar-md mt-n5 rounded-circle mx-auto d-block object-cover"
                    />
