...
const Ranking = () => {
  document.title = "Ranking | ABMC SCADA - Kibera Technology";
    ...
    () => [
      {
        ...
        Cell: (cell) => {
          if (cell.value < 4) {
            return (
              <div className="ranking text-info fw-semibold">#{cell.value}</div>
            );
          } else {
          ...
          <>
            <div className="collection">
              <div className="d-flex align-items-center">
                <img
                  src={collection.row.original.img}
                  alt=""
                  className="avatar-xs rounded-circle object-cover me-2"
                />{" "}
