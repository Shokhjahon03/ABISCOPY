...
const Creators = () => {
  document.title = "Creators | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
                    ...
                    <div className="d-flex">
                      <div className="flex-shrink-0">
                        <img
                          src={item.img}
                          alt=""
                          className="avatar-sm object-cover rounded"
                        />
                      </div>
          ...
          <Row>
            <Col lg={12}>
              <h5 className="card-title mb-4 fw-bold fs-17">
                Creators Grid Lists
              </h5>
            </Col>
          </Row>
                ...
                <Card>
                  ...
                  <div className="card-body text-center">
                    ...
                    <p className="text-muted">
                      You can make an NFT of a digital painting, a text, a piece
                      of music, a video.
                    </p>
                    <button
                      className={
                        item.isFollowBtn
                          ...
                          : "btn btn-soft-success w-100"
                      }
                    >
                      {item.isFollowBtn ? "Follow" : "Unfollow"}{" "}
                    </button>
                  </div>
                </Card>
              </Col>
