...
const ItemDetails = () => {
  document.title = "Item Details | ABMC SCADA - Kibera Technology";
  ...
  const renderer = ({ days, hours, minutes, seconds, completed }) => {
    if (completed) {
      ...
      return (
        <>
          <h5 id="auction-time-1" className="mb-0">
                  ...
                  <div className="sticky-side-div">
                    <Card className="ribbon-box border shadow-none right">
                      <div className="ribbon-two ribbon-two-danger">
                        <span>
                          <i className="ri-fire-fill align-bottom"></i> Hot
                        </span>
                      </div>
                        ...
                        <Row className="justify-content-center">
                          ...
                          <Col className="col-3">
                            <img
                              src={ImgGif3}
                              alt=""
                              className="img-fluid rounded h-100 object-cover"
                            />
                          </Col>
                          <Col className="col-3">
                            <img
                  ...
                  <div>
                    <UncontrolledDropdown className="float-end">
                      ...
                      <DropdownMenu className="dropdown-menu-end">
                        ...
                        <DropdownItem href="#" className="edit-item-btn">
                          <i className="ri-pencil-fill align-bottom me-2 text-muted"></i>{" "}
                          Edit
                        </DropdownItem>
                        <DropdownItem href="#" className="remove-item-btn">
                    ...
                    <span className="badge badge-soft-info mb-3 fs-12">
                      <i className="ri-eye-line me-1 align-bottom"></i> 8,634
                      people views this
                    </span>
                        ...
                        <div className="p-2 border border-dashed rounded text-center">
                          <div>
                            ...
                            <h5 className="fs-17 text-success mb-0">
                              <i className="mdi mdi-ethereum me-1"></i> 83.06
                              ETH
                            </h5>
                          </div>
                        </div>
                    ...
                    <div className="mt-4 text-muted">
                      ...
                      <p>
                        ...
                        values, norms and social practices that are steady over
                        time. In art, a pattern is a repetition of specific
                        visual elements. The dictionary.com definition of
                      ...
                      >
                                  ...
                                  <th scope="row">
                                    <div className="d-flex align-items-center">
                                      <img
                                        src={Img1}
                                        alt=""
                                        className="avatar-xs rounded object-cover"
                                      />
                                      <Link
                                        to="/apps-nft-item-details"
                                        className="link-dark"
                                      >
                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div className="d-flex align-items-center">
                                      ...
                                      <div className="ms-2">
                                        <Link to="#!">
                                          <h6 className="mb-1">Glen Matney</h6>
                                        </Link>
                                        <p className="text-muted mb-0">
                                          Creators
                                        </p>
                        ...
                        <TabPane id="nav-detail" tabId="3">
                          <div>
                            ...
                            <p>
                              Cultural patterns are the similar behaviors within
                              similar situations we witness due to shared
                              beliefs, values, norms and social practices that
                              are steady over time. In art, a pattern is a
                              repetition of specific visual elements. The
                              dictionary.com definition of "pattern" is: an
                              arrangement of repeated or corresponding parts,
                          ...
                          <div>
                            <div className="pb-3">
                              ...
                              <div className="text-center">
                                <div className="text-muted">
                                  Total <span className="fw-medium">7.32k</span>{" "}
                                  reviews
                                </div>
                              </div>
                            </div>
