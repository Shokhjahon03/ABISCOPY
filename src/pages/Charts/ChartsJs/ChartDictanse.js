...
const LineChartDistance = ({ dataColors, datas }) => {
      ...
      //   },
      {
        ...
        data:
          datahorizontal.length !== 0
            ? datahorizontal
            : [80, 23, 56, 65.45, 23.7987, 35, 85, 25, 92, 36],
      },
    ],
  };
  const option = {
  ...
  return (
    <React.Fragment>
      <Line width={803} height={220} data={data} options={option} />
    </React.Fragment>
  );
};
