...
const UiNotifications = () => {
  ...
  const bottomleftnotify = () =>
    toast("Welcome Back ! This is a Toast Notification", {
      position: "bottom-left",
      hideProgressBar: true,
      className: "bg-success text-white",
    });
  const bottomcenternotify = () =>
    toast("Welcome Back ! This is a Toast Notification", {
  ...
  const offsetnotify = () =>
    toast("Welcome Back ! This is a Toast Notification", {
      position: "top-right",
      hideProgressBar: true,
      className: "bg-success text-white m-5",
    });
  const closeiconnotify = () =>
    toast("Welcome Back ! This is a Toast Notification", {
      position: "top-right",
      hideProgressBar: true,
      className: "bg-success text-white",
  ...
  const durationnotify = () =>
    toast("Toast Duration 5s", {
      position: "top-right",
      hideProgressBar: false,
      className: "bg-success text-white",
    });

  document.title = "Notifications | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
                      ...
                      <Col xxl={6}>
                        ...
                        <div className="mt-4">
                          ...
                          <p className="text-muted">
                            ...
                            over whatever they might appear over.
                          </p>
                      ...
                      <Col xxl={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            ...
                            vertically stacking them in a readable manner.
                          </p>
                    ...
                    <div className="mt-5">
                      ...
                      <Row className="g-3">
                        <Col xxl={6}>
                          <div>
                            <p className="text-muted">
                              Place toasts with custom CSS as you need them. The
                              top right is often used for notifications, as is
                              the top middle. If you’re only ever going to show
                              one toast at a time, put the positioning styles
                        ...
                        <Col xxl={6}>
                          <div>
                            <p className="text-muted">
                              You can also get fancy with flexbox utilities to
                              align toasts horizontally and/or vertically.
                            </p>
                            <div
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Various example of <code>toast placement</code>.
                  </p>
                  <div className="live-preview">
                    <Form>
                      <div className="mb-3">
                    ...
                    <div
                      aria-live="polite"
                      aria-atomic="true"
                      className="bd-example bg-light position-relative"
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>toast-border-</code> with below-mentioned color
                    ...
                    <div className="position-relative">
                      ...
                      <div style={{ zIndex: "11" }}>
                        <Toast
                          isOpen={toast8}
                          id="borderedToast2"
                          className="toast-border-success overflow-hidden mt-3"
                        >
                          <ToastBody>
                            <div className="d-flex align-items-center">
                              <div className="flex-shrink-0 me-2">
                      ...
                      <div style={{ zIndex: "11" }}>
                        <Toast
                          isOpen={toast9}
                          id="borderedToast3"
                          className="toast-border-warning overflow-hidden mt-3"
                        >
                          <ToastBody>
                            <div className="d-flex align-items-center">
                              <div className="flex-shrink-0 me-2">
                      ...
                      <div style={{ zIndex: "11" }}>
                        <Toast
                          isOpen={toast10}
                          id="borderedToast4"
                          className="toast-border-danger overflow-hidden mt-3"
                        >
                          <ToastBody>
                            <div className="d-flex align-items-center">
                              <div className="flex-shrink-0 me-2">
