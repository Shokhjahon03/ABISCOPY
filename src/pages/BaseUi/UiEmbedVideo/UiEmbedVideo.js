...
const UiEmbedVideo = () => {
  document.title = "Embed Video | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Wrap any embed in<code>&lt;iframe&gt;</code> tag, in a
                    parent element, use <code>ratio-16x9</code> class to set
                    aspect ratio 16:9.{" "}
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>ratio-4x3</code> class to set aspect ratio 4:3.
                  </p>
                  <div className="live-preview">
                    {/* <!-- 4:3 aspect ratio --> */}
                  ...
                  <div className="d-none code-view">
                    <pre className="language-markup">
                      <code>
                        &lt;!-- Ratio Video 4:3 --&gt; &lt;div
                        className=&quot;ratio ratio-4x3&quot;&gt; &lt;iframe
                        src=&quot;https://www.youtube.com/embed/1y_kfWUCFDQ&quot;
                        title=&quot;YouTube video&quot;
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>--vz-aspect-ratio: 50%</code> to style element to
                  ...
                  <div className="d-none code-view">
                    <pre className="language-markup">
                      <code>
                        &lt;!-- Custom Ratio Video --&gt; &lt;div
                        className=&quot;ratio&quot;
                        style=&quot;--vz-aspect-ratio: 50%;&quot;&gt; &lt;iframe
                        src=&quot;https://www.youtube.com/embed/2RZQN_ko0iU&quot;
                        title=&quot;YouTube video&quot;
                        allowFullScreen&gt;&lt;/iframe&gt; &lt;/div&gt;
                      </code>
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>ratio-21x9</code> class to set aspect ratio 21:9.
                  </p>
                  <div className="live-preview">
                    {/* <!-- 21:9 aspect ratio --> */}
                  ...
                  <div className="d-none code-view">
                    <pre className="language-markup">
                      <code>
                        &lt;!-- Ratio Video 21:9 --&gt; &lt;div
                        className=&quot;ratio ratio-21x9&quot;&gt; &lt;iframe
                        src=&quot;https://www.youtube.com/embed/Z-fV2lGKnnU&quot;
                        title=&quot;YouTube video&quot;
                        allowFullScreen&gt;&lt;/iframe&gt; &lt;/div&gt;
                      </code>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>ratio-1x1</code> class to set aspect ratio 1:1.
                  </p>{" "}
                  <div className="live-preview">
                    {/* <!-- 1:1 aspect ratio --> */}
