...
const UiDropdowns = () => {
  ...
  document.title = "Dropdowns | ABMC SCADA - Kibera Technology";
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-</code> class with below mentioned variation
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>divider</code> attribute to DropdownItem to create
                    split button dropdowns as a single button dropdown.{" "}
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-3">
                      <ButtonGroup>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-lg</code> class to create a large size
                    dropdown button and <code>btn-sm</code> to create a small
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-3 align-items-center">
                      ...
                      <ButtonGroup>
                        <UncontrolledButtonDropdown>
                          <Button color="light" className="btn-lg">
                            Large split button
                          </Button>
                          <DropdownToggle
                            tag="button"
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>dropdown-menu-dark</code> class onto an existing
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Dropdown demo with various <code>dropdown alignment</code>{" "}
                    options.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-3">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <code>data-bs-reference</code> to change the position of the
                    dropdown.
                  </p>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xxl={3}>
                        <div>
                          <h6 className="font-size-13 mb-3">
                            Dropdown Menu Success link example
                          </h6>
                          <div className="clearfix">
                            <div
                              className="dropdown-menu d-inline-block position-relative dropdownmenu-success"
                              style={{ zIndex: "1" }}
                            >
                      ...
                      <Col lg={9}>
                        <div className="mt-lg-0 mt-3">
                          <h6 className="font-size-13 mb-0">
                        ...
                        <UncontrolledDropdown>
                          ...
                          <DropdownMenu>
                            <div className="dropdown-header noti-title">
                              <h5 className="font-size-13 text-muted text-truncate mb-0">
                                Welcome Jessie!
                              </h5>
                            </div>
                            <DropdownItem>Action</DropdownItem>
                        ...
                        >
                          <div className="dropdown-head bg-primary bg-pattern rounded-top">
                            ...
                            <div className="px-2 pt-2">
                              <Nav
                                tabs
                                className="dropdown-tabs nav-tabs-custom"
                              >
                                <NavItem>
                                  <NavLink
