...
const UiButtons = () => {
  document.title = "Buttons | ABMC SCADA - Kibera Technology";
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>Button</code> tag to show the default button
                    style.
                  </p>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>outline</code> atrribute with the below-mentioned
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill </code>class to make a rounded
                    button.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <Button color="light" className="rounded-pill">
                        {" "}
                        Light{" "}
                      </Button>
                    </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-soft-</code> class with the below-mentioned
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-ghost-</code> class with the below-mentioned
                    variation to create a button with the transparent
                    background.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>bg-gradient </code>class to create a gradient
                    button.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Button color="primary" className="bg-gradient">
                        {" "}
                        Primary{" "}
                      </Button>
                      <Button color="secondary" className="bg-gradient">
                        {" "}
                        Secondary{" "}
                      </Button>
                      <Button color="success" className="bg-gradient">
                        {" "}
                        Success{" "}
                      </Button>
                      <Button color="info" className="bg-gradient">
                        {" "}
                        Info{" "}
                      </Button>
                      <Button color="warning" className="bg-gradient">
                        {" "}
                        Warning{" "}
                      </Button>
                      <Button color="danger" className="bg-gradient">
                        {" "}
                        Danger{" "}
                      </Button>
                      <Button color="dark" className="bg-gradient">
                        {" "}
                        Dark{" "}
                      </Button>
                      <Button color="light" className="bg-gradient">
                        {" "}
                        Light{" "}
                      </Button>
                    </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>bg-animation </code>class to create an animated
                    button.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-label </code>class to create a button with the
                    label.
                  </p>
                  <div className="live-preview">
                    <Row>
                      ...
                      <Col lg={4}>
                        <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                          <Button
                            color="primary"
                            className="btn-label rounded-pill"
                          >
                            {" "}
                            <i className="ri-user-smile-line label-icon align-middle fs-16 me-2"></i>{" "}
                            Primary{" "}
                      ...
                      <Col lg={4}>
                        <div className="d-flex flex-wrap gap-2">
                          <Button color="primary" className="btn-label right">
                            {" "}
                          ...
                          <Button
                            color="success"
                            className="btn-label right rounded-pill"
                          >
                            {" "}
                            <i className="ri-check-double-line label-icon align-middle rounded-pill fs-16 ms-2"></i>{" "}
                            Success{" "}
                          </Button>
                        </div>
                      </Col>
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col lg={6}>
                        <div className="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                          <Button color="primary" className="btn-border">
                            Primary
                          </Button>
                          <Button color="secondary" className="btn-border">
                            Secondary
                          </Button>
                          <Button color="success" className="btn-border">
                            Success
                          </Button>
                          <Button color="warning" className="btn-border">
                            Warning
                          </Button>
                          <Button color="danger" className="btn-border">
                            Danger
                          </Button>
                        </div>
                      </Col>
                      <Col lg={6}>
                        <div className="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                          ...
                          <Button className="btn-soft-warning btn-border">
                            Warning
                          </Button>
                          <Button className="btn-soft-danger btn-border">
                            Danger
                          </Button>
                          <Button className="btn-soft-dark btn-border">
                            Dark
                          </Button>
                        </div>
                      </Col>
                        ...
                        <div className="d-flex flex-wrap align-items-center gap-2">
                          ...
                          >
                            <span className="icon-on">
                              <i className="ri-alarm-line align-bottom"></i>{" "}
                              Active
                            </span>
                          ...
                          >
                            <span className="icon-on">
                              <i className="ri-thumb-up-line align-bottom me-1"></i>{" "}
                              Yes
                            </span>
                            <span className="icon-off">
                          ...
                          >
                            <span className="icon-on">
                              <i className="ri-bookmark-line align-bottom me-1"></i>{" "}
                              Bookmark
                            </span>
                            <span className="icon-off">
                              <i className="ri-bookmark-3-fill align-bottom me-1"></i>{" "}
                              Unbookmark
                            </span>
                          </Button>
                        </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-lg</code> class to create a large size button
                    and <code>btn-sm</code> class to create a small size button.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap align-items-center gap-2">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>w-xs,w-sm,w-md,w-lg</code> class to make different
                    sized buttons respectively.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Button color="primary" className="w-xs">
                        {" "}
                        Xs{" "}
                      </Button>
                      <Button color="danger" className="w-sm">
                        {" "}
                        Small{" "}
                      </Button>
                      <Button color="warning" className="w-md">
                        {" "}
                        Medium{" "}
                      </Button>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn</code> class with different HTML elements.
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>data-bs-toggle="button"</code> to toggle a
                  ...
                  <div className="d-none code-view">
                    <pre className="language-markup">
                      <code>
                        &lt;!-- Toggle Button Status --&gt; &lt;button
                        type=&quot;button&quot; className=&quot;btn btn-primary
                        waves-effect waves-light&quot;
                        data-bs-toggle=&quot;button&quot;
                        aria-pressed=&quot;false&quot;&gt; Single toggle
                        &lt;/button&gt;
                      </code>
                    </pre>
                  </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>d-grid</code> class to create a full-width block
                    button.
                  </p>
                  <div className="live-preview">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <a href="https://getbootstrap.com/docs/5.1/forms/checks-radios/">
                      toggle buttons
                    </a>{" "}
                    ...
                    <div className="d-flex flex-wrap align-items-center gap-2">
                      <ButtonGroup>
                        <Input
                          ...
                          defaultChecked=""
                        />
                        <Button color="primary" className="mb-0" id="btncheck1">
                          {" "}
                          Checkbox 1{" "}
                        </Button>
                        ...
                        <Input
                          ...
                          id="btncheck2"
                        />
                        <Button color="primary" className="mb-0" id="btncheck2">
                          {" "}
                          Checkbox 2{" "}
                        </Button>
                        ...
                        <Input
                          ...
                          id="btncheck3"
                        />
                        <Button color="primary" className="mb-0" id="btncheck3">
                          {" "}
                          Checkbox 3{" "}
                        </Button>
                      </ButtonGroup>
          ...
          <Row>
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>btn-group </code> class in the parent class to
            ...
            <Col lg={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-icon</code> class to wrap icon in button
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col sm={6}>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-toolbar</code> class to combine sets of button
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>btn-group-</code> class with the below-mentioned
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Make a set of buttons appear <code>vertically</code> stacked
