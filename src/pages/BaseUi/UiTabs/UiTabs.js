...
const UiTabs = () => {
  ...
  document.title = "Tabs | ABMC SCADA - Kibera Technology";
                  ...
                  <TabContent activeTab={activeTab} className="text-muted">
                    <TabPane tabId="1" id="home">
                      ...
                      <p className="mb-0">
                        ...
                        or graphic. That's why it's important to think about
                        your message, then choose a font that fits. Cosby
                    ...
                    <TabPane tabId="2" id="product">
                      ...
                      <p className="mb-0">
                        ...
                        simple. Qui photo booth letterpress, commodo enim craft
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-justified</code> class to generate equal-width
                    elements with all horizontal space will be occupied by nav
                    links.
                  </p>
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-pills</code> class to generate particular
                  ...
                  <Nav pills className="nav-success mb-3">
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: pillsTab === "4" })}
                        onClick={() => {
                          pillsToggle("4");
                        }}
                      >
                  ...
                  <TabContent activeTab={pillsTab} className="text-muted">
                    <TabPane tabId="1" id="home-1">
                      ...
                      <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2">
                          Too much or too little spacing, as in the example
                    ...
                    <TabPane tabId="2" id="profile-1">
                      <div className="d-flex">
                        ...
                        <div className="flex-grow-1 ms-2">
                          ...
                          fix fonts that are poorly spaced to begin with.
                        </div>
                      </div>
                      <div className="d-flex mt-2">
                        <div className="flex-shrink-0">
                    ...
                    <TabPane tabId="3" id="messages-1">
                      ...
                      <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2">
                          ...
                          many different professional graphic designers and
                    ...
                    <TabPane tabId="4" id="settings-1">
                      ...
                      <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2">
                          ...
                          design basics, I came up with a list of 30 graphic
                          design tips that you can start implementing.
                        </div>
                      </div>
                    </TabPane>
                  </TabContent>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-pills nav-justified</code> class to generate
                    equal-width elements without borders, all horizontal space
                    will be occupied by nav links.
                  </p>
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>flex-column</code> class to create Vertical nav
                    tabs.
                  </p>
                  <Row>
                    <Col md={3}>
                      ...
                      >
                        <TabPane tabId="1" id="v-pills-home">
                          ...
                          <p className="mb-0">
                            ...
                            received from the designers I spoke with. They
                            highly encourage that you use different fonts in one
                        ...
                        <TabPane tabId="2" id="v-pills-profile">
                          <div className="d-flex mb-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                {" "}
                                I also decreased the transparency in the text so
                                that the mountains come through the text,
                                bringing the quote truly to life. Make sure that
                                the placement of your text is pleasing to look
                                at, and you try to achieve symmetry for this
                                effect.
                              </p>
                            </div>
                          </div>
                          <p className="mb-0">
                            You've probably heard that opposites attract. The
                            same is true for fonts. Don't be afraid to combine
                            font styles that are different but complementary.
                            You can always play around with the text that is
                        ...
                        <TabPane tabId="3" id="v-pills-messages">
                          <div className="d-flex mb-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                In this image, you can see that the line height
                                has been reduced significantly, and the size was
                                brought up exponentially. Experiment and play
                                around with the fonts that you already have in
                                the software you’re working with reputable font
                                websites.
                              </p>
                            </div>
                          </div>
                          <p className="mb-0">
                            They highly encourage that you use different fonts
                            in one design, but do not over-exaggerate and go
                            overboard This may be the most commonly encountered
                          ...
                          <div className="d-flex mb-2">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                ...
                                attention and portray to them what you’re trying
                                to say. You can make a big statement by using
                                little tricks, like this one. Use contrasting
                                fonts. you can use a bold sanserif font with a
                                cursive.
                              </p>
                            </div>
                          </div>
                          <p className="mb-0">
                            If you’re using multiple elements, make sure that
                            your principal object is larger than the others, as
                            the eye of your viewer will automatically be drawn
                            to the larger of the two objects.
                          </p>
                        </TabPane>
                      </TabContent>
                    </Col>
                ...
                <div className="card-header align-items-center d-flex">
                  <div className="flex-grow-1 oveflow-hidden">
                    <p className="text-muted text-truncates mb-0">
                      Use <code>card-header-tabs</code> class to create card
                      header tabs.
                    </p>
                  </div>
                  ...
                  <TabContent activeTab={cardHeaderTab} className="text-muted">
                    <TabPane tabId="1" id="home2">
                      <p className="flex-grow-1 mb-0">
                        <img
                          src={avatar2}
                          alt=""
                          className="avatar-lg rounded float-start me-3"
                        />
                        ...
                        twee. commodo enim craft beer mlkshk aliquip jean shorts
                        ullamco ad vinyl cillum PBR. Homo nostrud organic,
                        assumenda labore aesthetic magna delectus.commodo enim
                        craft beer mlkshk aliquip jean shorts ullamco ad vinyl
                        cillum PBR. Homo nostrud organic, assumenda labore
                        aesthetic magna delectus. If you’re using multiple
                        elements, make sure that your principal object is larger
                        than assumenda.
                      </p>
                    </TabPane>
                    ...
                    <TabPane tabId="2" id="profile2">
                      <p className="me-3 mb-0">
                        <img
                          src={avatar3}
                          alt=""
                          className="avatar-lg rounded float-end ms-3"
                        />{" "}
                        Experiment and play around with the fonts that you
                        already have in the software you’re working with
                        reputable font websites. commodo enim craft beer mlkshk
                        aliquip jean shorts ullamco ad vinyl cillum PBR. Homo
                        nostrud organic, assumenda labore aesthetic magna
                        delectus.commodo enim craft beer mlkshk aliquip jean
                        shorts ullamco ad vinyl cillum PBR. Homo nostrud
                        organic, assumenda labore aesthetic magna delectus Scale
                        all elements of your design: text, elements, buttons,
                        everything. Increase or decrease the letter spacing
                        depending on the situation and try, try again until it
                    ...
                    <TabPane tabId="3" id="messages2">
                      <p className="ms-3 mb-0">
                        ...
                        pack portland seitan DIY, art party locavore wolf cliche
                        high life echo park Austin. Cred vinyl keffiyeh DIY
                        salvia PBR, beer mlkshk aliquip jean shorts ullamco ad
                        vinyl cillum PBR. Homo nostrud organic, assumenda labore
                        aes Homo nostrud organic, assumenda labore aesthetic
                        magna delectus Scale all elements of your design: text,
                        elements, buttons, everything.Increase or decrease the
          ...
          <Row>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>arrow-navtabs </code>class to create arrow nav
                    tabs.
                  </p>
                  <Nav
                    pills
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <div className="card-header align-items-xl-center d-xl-flex">
                  <p className="text-muted flex-grow-1 mb-xl-0">
                    Use <code>card-header-pills</code> class to create header
                    justify tab.
                  </p>
                  <div className="flex-shrink-0">
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>card-footer-tabs</code> class to create the bottom
                    card nav justify tab.
                  </p>
                  <TabContent activeTab={bottomCardTab} className="text-muted">
                    <TabPane tabId="1" id="bottomtabs-home">
                      ...
                      <p className="mb-2">
                        On the note of consistency, color consistency is a MUST.
                        If you’re not trying to create crazy contrast in your
                        design, then a great idea would be for you to use a
                        color palette throughout your entire design. It will
                        subconsciously interest viewers and also is very
                        pleasing to look at.
                      </p>
                      <p className="mb-0">
                        Any bypasser will stop to see what you have to see, even
                        if your design has nothing to do with them, for the
                        simple fact that it is beautiful to look at.
                      </p>
                    </TabPane>
                    ...
                    <TabPane tabId="2" id="bottomtabs-profile">
                      ...
                      <p className="mb-2">
                        Just like in the image where we talked about using
                        multiple fonts, you can see that the background in this
                        graphic design is blurred. Whenever you put text on top
                        of an image, it’s important that your viewers can
                        understand the text, and sometimes that means applying a
                        gaussian readable.
                      </p>
                      <p className="mb-0">
                    ...
                    <TabPane tabId="3" id="bottomtabs-messages">
                      ...
                      <p className="mb-2">
                        Blowzy red vixens fight for a quick jump. Joaquin
                        Phoenix was gazed by MTV for luck. A wizard’s job is to
                        vex chumps quickly in fog. Watch "Jeopardy! ", Alex
                        Trebek's fun TV quiz game. Woven silk pyjamas exchanged
                        for blue quartz. Brawny gods just flocked up to quiz and
                        vex him.
                      </p>
                      <p className="mb-0">
                        Big July earthquakes confound zany experimental vow. My
                        girl wove six dozen plaid jackets before she quit. Six
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>custom-hover-nav-tabs</code> class to create
                    custom hover tabs.
                  </p>
                </CardBody>
                        ...
                        <table className="table mb-0">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
                                4.4{" "}
                                <i className="ri-star-s-fill ms-1 text-warning align-middle"></i>
                              </td>
                            </tr>
                            <tr>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>custom-verti-nav-pills</code> class to create
                    custom vertical tabs.
                  </p>
                  <Row>
                    <Col lg={3}>
                      ...
                      >
                        <TabPane tabId="1" id="custom-v-pills-home">
                          <div className="d-flex mb-4">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                Experiment and play around with the fonts that
                                you already have in the software you’re working
                                with reputable font websites. commodo enim craft
                          ...
                          <div className="d-flex">
                            <div className="flex-grow-1 me-3">
                              <p className="mb-0">
                                Always want to make sure that your fonts work
                                well together and try to limit the number of
                                fonts you use to three or less. Experiment and
                                play around with the fonts that you already have
                                in the software you’re working with reputable
                                font websites.
                              </p>
                            </div>
                            <div className="flex-shrink-0">
                          ...
                          <div className="d-flex mb-4">
                            ...
                            <div className="flex-grow-1 ms-3">
                              <p className="mb-0">
                                ...
                                begin with. A wonderful serenity has taken
                          ...
                          <div className="d-flex">
                            <div className="flex-grow-1 me-3">
                              <p className="mb-0">
                                ...
                                birthed into this world, and while you have the
                                opportunity to be creative and make your own
                                style choices. For that very reason, I went on a
                                quest and spoke to many different professional
                                graphic designers.
                              </p>
                            </div>
                            <div className="flex-shrink-0">
                          ...
                          <div className="d-flex">
                            <div className="flex-grow-1 me-3">
                              <p className="mb-0">
                                ...
                                important to think about your message, then
                                choose a font that fits. Cosby sweater eu banh
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>animation-nav</code> class to create animated
                    tabs.
                  </p>
                ...
                <CardBody>
                  ...
                  <Nav tabs className="nav-tabs nav-justified mb-3">
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: navBadgeTab === "1" })}
                        onClick={() => {
                          navBadgeToggle("1");
                        }}
                      >
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: navBadgeTab === "2" })}
                        onClick={() => {
                          navBadgeToggle("2");
                        }}
                      >
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: navBadgeTab === "3" })}
                        onClick={() => {
                          navBadgeToggle("3");
                        }}
                      >
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: navBadgeTab === "4" })}
                        onClick={() => {
                          navBadgeToggle("4");
                        }}
                      >
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-border-top</code> class to create nav tabs
                    with border at top.
                  </p>
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-border-top nav-justified</code> class to
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    *Use <code>nav-custom-</code> class with modifier class to
                    color tabs.
                  </p>
                    ...
                    <TabPane tabId="1" id="border-navs-home">
                      ...
                      >
                        ...
                        <div className="d-flex mt-2">
                          ...
                          <div className="flex-grow-1 ms-2">
                            Too much or too little spacing, as in the example
                            below, can make things unpleasant for the reader.
                            The goal is to make your text as comfortable to read
                            as possible.
                          </div>
                        </div>
                      </div>
          ...
          <Row>
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  ...
                  <Nav
                    pills
                    className="nav nav-pills nav-custom nav-custom-success mb-3"
                  >
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: colorNavTab === "1" })}
                        onClick={() => {
                          colorNavToggle("1");
                        }}
                      >
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: colorNavTab === "2" })}
                        onClick={() => {
                          colorNavToggle("2");
                        }}
                      >
                    ...
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                        className={classnames({ active: colorNavTab === "3" })}
                        onClick={() => {
                          colorNavToggle("3");
                        }}
                      >
                    ...
                    <TabPane tabId="1" id="nav-colored-home">
                      <div className="d-flex mb-3">
                        ...
                        <div className="flex-grow-1 ms-3">
                          ...
                          beer twee. commodo enim craft beer mlkshk aliquip jean
                          shorts ullamco.
                        </div>
                      </div>
                      <div className="d-flex">
                        <div className="flex-grow-1 me-3">
                          For that very reason, I went on a quest and spoke to
                          many different professional graphic designers and
                          asked them what graphic design tips they live. vinyl
                          cillum PBR. Homo nostrud organic, assumenda labore
                    ...
                    <TabPane tabId="2" id="nav-colored-profile">
                      <div className="d-flex mb-3">
                        ...
                        <div className="flex-grow-1 ms-3">
                          ...
                          and each. next level wes anderson artisan four loko
                          farm-to-table craft beer twee. commodo enim craft beer
                    ...
                    <TabPane tabId="3" id="nav-colored-messages">
                      ...
                      <div className="d-flex">
                        <div className="flex-grow-1 me-3">
                          Increase or decrease the letter spacing depending on
                          the situation and try, try again until it looks right,
                          and each assumenda labore aes Homo nostrud organic,
                          assumenda labore aesthetic magna elements, buttons,
                          everything..
                        </div>
                        <div className="flex-shrink-0">
                          <img
            ...
            <Col xxl={6}>
              ...
              <Card>
                <CardBody>
                  <p className="text-muted">
                    Use <code>nav-custom-light</code> class to lighten the nav
                    tabs area.
                  </p>

                  <Nav
                    pills
                    className="nav nav-pills nav-custom nav-custom-light mb-3"
                  >
                    <NavItem>
                      <NavLink
                        style={{ cursor: "pointer" }}
                  ...
                  <TabContent activeTab={lightNavTab} className="text-muted">
                    <TabPane tabId="1" id="nav-light-home">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          ...
                          magna delectus. pposites attract, and that’s a fact.
                          It’s in our nature to be interested in the unusual,
                          and that’s why using contrasting.
                        </div>
                        <div className="flex-shrink-0">
                          <img
                            src={img4}
                    ...
                    <TabPane tabId="2" id="nav-light-profile">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          Just like in the image where we talked about using
                          multiple fonts, you can see that the background in
                          this graphic design is blurred. Whenever you put text
                          on top of an image, it’s important that your viewers
                          can understand the text, and sometimes that means
                          applying a gaussian readable Any bypasser will stop to
                          see what you have to see, even if your design has
                      ...
                      <p className="mb-0">
                        ...
                        each letter has the perfect spot of its own. commodo
                    ...
                    <TabPane tabId="3" id="nav-colored-messages">
                      <div className="d-flex mb-1">
                        <div className="flex-grow-1 me-3">
                          ...
                          cleanse gluten-free squid scenester freegan cosby
                          sweater. Fanny pack portland seitan DIY, art party
                          locavore wolf cliche high life echo park Austin On the
                          note of consistency, color consistency is a MUST. If
                          you’re not trying to create crazy contrast in your
                          design.
                        </div>
                        <div className="flex-shrink-0">
                          <img
                      ...
                      <p className="mb-0">
                        Big July earthquakes confound zany experimental vow. My
                        girl wove six dozen plaid jackets before she quit. Six
                        big devils from Japan quickly forgot how to waltz. try
                        again until it looks right, and each assumenda labore
                        aes Homo nostrud organic, assumenda labore aesthetic
