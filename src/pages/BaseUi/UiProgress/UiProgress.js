...
const UiProgress = () => {
  document.title = "Progress | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>color="Required Color"</code> attribute to
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Multiple bar color to change the appearance of individual
                    progress bars.
                  </p>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>progress-sm</code>, <code>progress-lg</code>, or{" "}
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>striped</code> attribute to add strip to the
                    progress.
                  </p>
                  <div className="live-preview">
                    <div className="mb-4">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>striped animated</code> attribute to add strip
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>bg-gradient</code> class to show gradient progress
                    bar.
                  </p>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>animated-progess</code> class to show progress
                    with animation.
                  </p>
                  <div className="live-preview">
                    <div className="mb-4">
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>animated-progess custom-progess </code> class to
                  ...
                  <div className="live-preview">
                    <div className="mb-4">
                      <Progress
                        value={15}
                        color="primary"
                        className="animated-progess custom-progress"
                      />
                    </div>
                    <div className="mb-4">
                      <Progress
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use{" "}
                    <code>animated-progess custom-progess progress-label</code>{" "}
          ...
          <Row>
                    ...
                    <Card className="bg-light overflow-hidden shadow-none">
                      <CardBody>
                        <div className="d-flex">
                          <div className="flex-grow-1">
                            <h6 className="mb-0">
                              <b className="text-secondary">30%</b> Update in
                              progress...
                            </h6>
                          </div>
                    ...
                    <Card className="bg-light overflow-hidden shadow-none">
                      <CardBody>
                        <div className="d-flex">
                          <div className="flex-grow-1">
                            <h6 className="mb-0">
                              <b className="text-success">60%</b> Update in
                              progress...
                            </h6>
                          </div>
                          <div className="flex-shrink-0">
                      ...
                      <div>
                        <Progress
                          value={60}
                          color="success"
                          className="bg-soft-success rounded-0"
                        />
                      </div>
                    </Card>
                    ...
                    <Card className="bg-light overflow-hidden shadow-none">
                      <CardBody>
                        <div className="d-flex">
                          <div className="flex-grow-1">
                            <h6 className="mb-0">
                              <b className="text-danger">82%</b> Update in
                              progress...
                            </h6>
                          </div>
                          <div className="flex-shrink-0">
                      ...
                      <div>
                        <Progress
                          value={82}
                          color="danger"
                          className="bg-soft-danger rounded-0"
                        />
                      </div>
                    </Card>
                  </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted pb-2">
                    Here is the example of progress which is represented by
                    steps completion.
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted pb-2">
                    Use <code>progress-step-arrow </code>class to create step
                  ...
                  <div className="live-preview">
                    <Progress
                      multi
                      className="progress-step-arrow progress-info"
                    >
