...
const UiList = () => {
  document.title = "List | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>ListGroup</code> attribute in an unordered list
                    and <code>ListGroupItem</code> attribute to create a default
                    list group.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem>
                        <i className="ri-bill-line align-middle me-2"></i> Send
                      ...
                      <ListGroupItem>
                        <i className="ri-secure-payment-line align-middle me-2"></i>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>active</code> attribute to{" "}
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>disabled</code> attribute to{" "}
                    <code>ListGroupItem</code> to make it <em>appear</em>{" "}
                    disabled.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem disabled>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-2">James Ballard</div>
                        </div>
                      </ListGroupItem>
                      <ListGroupItem>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-2">Nancy Martino</div>
                        </div>
                      </ListGroupItem>
                      <ListGroupItem>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-2">Henry Baird</div>
                        </div>
                      </ListGroupItem>
                      <ListGroupItem>
                        <div className="d-flex align-items-center">
                          ...
                          <div className="flex-grow-1 ms-2">Erica Kernan</div>
                        </div>
                      </ListGroupItem>
                    </ListGroup>
                  </div>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag="a"</code> to create actionable list group
                  ...
                  <div className="live-preview">
                    <ListGroup className="list-group-fill-success">
                      ...
                      >
                        <i className="ri-download-2-fill align-middle me-2"></i>
                        Category Download
                      </ListGroupItem>
                      <ListGroupItem
                        tag="a"
                      ...
                      <ListGroupItem
                        ...
                        className="list-group-item-action"
                      >
                        <i className="ri-database-2-line align-middle me-2"></i>
                        Storage folder
                      </ListGroupItem>
                      <ListGroupItem
                        tag="a"
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag="button"</code> to create actionable list
                  ...
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem
                        ...
                        className="list-group-item-action active"
                      >
                        <i className="ri-reply-fill align-middle me-2"></i>Reply
                      </ListGroupItem>
                      <ListGroupItem
                        tag="button"
                        className="list-group-item-action"
                      >
                        <i className="ri-share-forward-fill align-middle me-2"></i>
                        Forward Message
                      </ListGroupItem>
                      <ListGroupItem
                        tag="button"
                        className="list-group-item-action"
                      >
                        <i className="ri-equalizer-line align-middle me-2"></i>
                        Filter Message
                      </ListGroupItem>
                      <ListGroupItem
                        tag="button"
                        className="list-group-item-action"
                      >
                        <i className="ri-delete-bin-5-line align-middle me-2"></i>
                        Delete Message
                      </ListGroupItem>
                      <ListGroupItem
                        tag="button"
                        ...
                        disabled
                      >
                        <i className="ri-forbid-line align-middle me-2"></i>
                        Block "Mark Spencer
                      </ListGroupItem>
                    </ListGroup>
                  </div>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>flush</code> attribute to ListGroup to remove some
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>horizontal</code> attribute to ListGroup to change
                    the layout of list group items from vertical to horizontal
          ...
          <Row>
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>color="Required color"</code> to style list items
                    with a stateful background and color.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>tag="a" to="#"</code> to add link. Note the
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-group-fill-</code> with modifier class to
                    style list items with a stateful background and color.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem>Dapibus ac facilisis in</ListGroupItem>
                      <ListGroupItem className="list-group-fill-primary">
                        A simple primary list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-secondary">
                        A simple secondary list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-success">
                        A simple success list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-danger">
                        A simple danger list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-warning">
                        A simple warning list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-info">
                        A simple info list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-light">
                        A simple light list group item
                      </ListGroupItem>
                      <ListGroupItem className="list-group-fill-dark">
                        A simple dark list group item
                      </ListGroupItem>
                    </ListGroup>
                  </div>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    <Link to="https://getbootstrap.com/docs/5.1/utilities/flex/">
                      flexbox utilities
                    </Link>
                    .
                  </p>
                  <div className="live-preview">
                    <ListGroup>
                      <ListGroupItem
                        ...
                        className="list-group-item-action active"
                      >
                        <div className="float-end">Pending</div>
                      ...
                      <ListGroupItem
                        ...
                        className="list-group-item-action"
                      >
                        <div className="float-end">Rejected</div>
                        <div className="d-flex mb-2 align-items-center">
                          <div className="flex-shrink-0">
                            <img
                              src={avatar3}
                        ...
                        <p className="list-text mb-0">
                          ...
                          try again until it looks right, and each assumenda
                          labore aes Homo nostrud organic, assumenda labore
                      ...
                      <ListGroupItem
                        ...
                        className="list-group-item-action"
                      >
                        <div className="float-end">Successful</div>
                        <div className="d-flex mb-2 align-items-center">
                          <div className="flex-shrink-0">
                            <img
                              src={avatar4}
          ...
          <Row>
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use badges to any list group item to show unread counts,
                    activity, and more with the help of some{" "}
                    <Link to="https://getbootstrap.com/docs/5.1/utilities/">
                      utilities
                    </Link>
                    .
                  </p>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use Bootstrap’s checkboxes within list group items and
                    customize as needed.{" "}
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use Bootstrap’s radios within list group items and customize
                    as needed.{" "}
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use icons to any list group item to show icons to list group
                    items.
                  </p>
                  <div className="live-preview">
                    <ListGroup>
            ...
            <Col xxl={4} xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-group-numbered</code> class (optionally use
                    an <code>&lt;ol&gt;</code> element) to show numbered list
                    group items.{" "}
                  </p>
                  <div className="live-preview">
