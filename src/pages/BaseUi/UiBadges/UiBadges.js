...
const UiBadges = () => {
  document.title = "Badges | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>Badge</code> tag to set a default badge.
                  </p>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>badge-soft-</code> class with the
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge badge-soft-light text-dark">
                        Light
                      </span>
                    </div>
                  </div>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>badge-outline-</code> class with the
                    below-mentioned variation to create a badge with the
                    outline.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    below-mentioned variation to create a badge more rounded
                ...
                <CardBody>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      ...
                      <span className="badge badge-soft-info badge-border">
                        Info
                      </span>
                      <span className="badge badge-soft-dark badge-border">
                        Dark
                      </span>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>rounded-pill badge-outline-</code> class with
                    the below-mentioned variation to create a outline Pill
                    badge.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>badge-label</code> class to create a badge
                    with the label.
                  </p>
                  ...
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
                      <Badge color="primary" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Primary{" "}
                      </Badge>
                      <Badge color="secondary" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Secondary{" "}
                      </Badge>
                      <Badge color="success" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Success{" "}
                      </Badge>
                      <Badge color="danger" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Danger{" "}
                      </Badge>
                      <Badge color="warning" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Warning{" "}
                      </Badge>
                      <Badge color="info" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Info{" "}
                      </Badge>
                      <Badge color="dark" className="badge-label">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Dark{" "}
                      </Badge>
                      <Badge color="light" className="badge-label text-dark">
                        {" "}
                        <i className="mdi mdi-circle-medium"></i> Light{" "}
                      </Badge>
                    </div>
                  </div>
                  <div className="d-none code-view">
          ...
          <Row>
            <Col xxl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>badge-gradient-*</code> class to create a
                    gradient styled badge.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex flex-wrap gap-2">
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the below utilities to modify a badge and position it in
