...
const UiModals = () => {
  ...
  document.title = "Modals | ABMC SCADA - Kibera Technology";
  ...
  return (
    <React.Fragment>
        ...
        <div className="modal-body text-center p-5">
          ...
          <div className="mt-4 pt-3">
            ...
            <div className="hstack gap-2 justify-content-center">
              ...
              <Button color="light" onClick={() => tog_togSecond(false)}>
                Close
              </Button>
            </div>
          </div>
      ...
      >
          ...
          <div className="d-flex mt-2">
            ...
            <div className="flex-grow-1 ms-2 ">
              <p className="text-muted mb-0">
                ...
                make things unpleasant for the reader. The goal is to make your
        ...
        <div className="modal-footer">
          <Button color="light" onClick={() => setmodal_scroll(false)}>
            Close
          </Button>
          <Button color="primary">Save changes</Button>
        </div>
          ...
          <div className="mt-4">
            ...
            <div className="hstack gap-2 justify-content-center">
              <Link
                to="#"
                className="btn btn-link link-success fw-medium"
                onClick={() => setmodal_positionBottomRight(false)}
              >
                <i className="ri-close-line me-1 align-middle"></i> Close
              </Link>
              <Link to="#" className="btn btn-success">
          ...
          <div className="mt-2">
            ...
            <div className="hstack gap-2 justify-content-center">
              ...
              <button className="btn btn-soft-success">
                <i className="ri-links-line align-bottom"></i> Copy tracking
                link
              </button>
            </div>
          </div>
          ...
          <Col lg={7}>
            <div className="modal-body p-5">
              <h2 className="lh-base">
                ...
                <span className="text-danger">20% off</span> experiences!
              </h2>
              <p className="text-muted mb-4">
                A free bet is a bet which is provided by a betting site for a
                customer to place and then benefit from the winnings. Free bets
                are commonly used as welcome offers.
              </p>
              ...
              <div className="form-check">
                ...
                <label className="form-check-label" htmlFor="exampleCheck1">
                  By subscribing to a particular channel or user on YouTube, you
      ...
      >
        ...
        <Alert color="success" className="rounded-0 mb-0">
          <p className="mb-0">
            Up to <span className="fw-semibold">50% OFF</span>, Hurry up before
            the stock ends
          </p>
        </Alert>
        <ModalBody>
          <form>
            ...
            <div className="mb-3 form-check">
              ...
              <label className="form-check-label" htmlFor="checkTerms">
                I agree to the{" "}
                <span className="fw-semibold">Terms of Service</span> and
                Privacy Policy
              </label>
            </div>
            <div className="text-end">
