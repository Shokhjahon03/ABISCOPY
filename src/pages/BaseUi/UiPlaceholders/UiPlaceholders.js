...
const UiPlaceholders = () => {
  document.title = "Placeholders | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    , or <code>placeholder-xs</code> class to placeholder class
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>bg-</code> class with the below-mentioned color
