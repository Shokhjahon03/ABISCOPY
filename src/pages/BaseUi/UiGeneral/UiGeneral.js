...
const UiGeneral = () => {
  document.title = "General | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Popovers example are available with follwing options ,
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Tooltip example are available with follwing options,
                    Directions are mirrored when using Bootstrap in RTL.
                  </p>
                  <div className="live-preview">
                    <div className="hstack flex-wrap gap-2">
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col lg={6}>
                        ...
                        <p className="text-muted">
                          Use <code>Pagination</code> attribute to ul element to
                          indicate a series of related content exists across
                          multiple pages.
                        </p>
                        <Pagination>
                          <PaginationItem>
                      ...
                      <Col lg={6}>
                        <div className="mt-4 mt-lg-0">
                          ...
                          <p className="text-muted">
                            ...
                            PaginationItem to links that appear un-clickable and{" "}
                            <code>active</code> class to indicate the current
                            page.
                          </p>
                          <Pagination>
                    ...
                    <Row>
                      ...
                      <Col lg={6}>
                        <div className="mt-4">
                          ...
                          <p className="text-muted">
                            Use <code>justify-content-start</code>,{" "}
                            <code>justify-content-start</code>, or{" "}
                            <code>justify-content-start</code>, class to
                            pagination class to change the alignment of
                    ...
                    <Row>
                      <Col lg={6}>
                        <div className="mt-4">
                          ...
                          <p className="text-muted">
                            Use <code>pagination-separated</code> class to
                            pagination class to set custom separated pagination.
                          </p>
                      ...
                      <Col lg={6}>
                        <div className="mt-4">
                          ...
                          <p className="text-muted">
                            Use <code>pagination-rounded</code> class to
                            pagination class to set custom rounded pagination.
                          </p>
                    ...
                    <Row>
                      <Col lg={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>Spinner</code> attribute for a lightweight
                            loading indicator.
                          </p>
                      ...
                      <Col lg={6}>
                        <div>
                          ...
                          <p className="text-muted">
                            Use <code>spinner-grow</code> class for a
