...
const UiRibbons = () => {
  document.title = "Ribbons | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
                  ...
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>round-shape</code> class to show round-shaped
                        ribbon.
                      </p>
                      <Col xxl={4}>
                          ...
                          <CardBody>
                            ...
                            <div className="ribbon-content mt-4 text-muted">
                              <p className="mb-0">
                                ...
                                dictum aliquet. Nulla sapien mauris, eleifend et
                      ...
                      <Col xxl={4}>
                        <div className="card ribbon-box border shadow-none mb-lg-0">
                          <CardBody>
                            <div className="ribbon ribbon-success round-shape">
                              Success
                            </div>
                            <h5 className="fs-14 text-end">Rounded Ribbon</h5>
                            <div className="ribbon-content mt-4 text-muted">
                      ...
                      <Col xxl={4}>
                        ...
                        <div className="card ribbon-box border shadow-none right mb-lg-0">
                          <CardBody>
                            <div className="ribbon ribbon-info round-shape">
                              Info
                            </div>
              ...
              <Card>
                ...
                <CardBody>
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>ribbon-shape</code> class to show ribbon
                        shaped ribbon.
                      </p>
                      <Col xxl={4}>
                        <div className="card ribbon-box border shadow-none mb-lg-0">
              ...
              <Card>
                ...
                <CardBody>
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>ribbon-fill</code> class to show fill-shaped
                        ribbon.
                      </p>
                      <Col xxl={4}>
              ...
              <Card>
                ...
                <CardBody>
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>ribbon-box</code> class with{" "}
                        <code>ribbon-two</code> class at child element to show
                        below-mentioned shaped ribbon.
                      </p>
                      <Col xxl={4}>
                        <div className="card ribbon-box border shadow-none mb-lg-0">
                          <div className="card-body text-muted">
                            ...
                            <p className="mb-0">
                              ...
                              commodo dapibus odio. Vivamus pretium nec odio
                              cursus.
                            </p>
                          </div>
                        </div>
                ...
                <CardBody>
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>ribbon-box</code> class with{" "}
                        <code>ribbon-three</code> class at child element to show
                        below-mentioned shaped ribbon.
                      </p>
                      <Col xxl={4}>
                        <div className="card ribbon-box border shadow-none mb-lg-0">
              ...
              <Card>
                ...
                <CardBody>
                  <div className="live-preview">
                    <Row className="g-3">
                      <p className="text-muted">
                        Use <code>trending-ribbon</code> class to show ribbon
                        with hovering effect.
                      </p>
                      <Col xxl={4}>
                        <div className="card ribbon-box border shadow-none overflow-hidden mb-lg-0">
                          <div className="card-body text-muted">
                            <div className="ribbon ribbon-info ribbon-shape trending-ribbon">
                              ...
                              <i className="ri-flashlight-fill text-white align-bottom float-end ms-1"></i>
                            </div>
                            <h5 className="fs-14 text-end mb-3">
                              Ribbon Shape
                            </h5>
