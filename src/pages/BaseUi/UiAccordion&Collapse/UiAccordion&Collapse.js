...
const UiAccordions = () => {
  ...
  document.title = "Accordions | ABMC SCADA - Kibera Technology";
                    ...
                    <Accordion id="default-accordion-example">
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            Although you probably won’t get into any legal
                            trouble if you do it just once, why risk it? If you
                            made your subscribers a promise, you should honor
                            that. If not, you run the risk of a drastic increase
                            in opt outs, which will only hurt you in the long
                            run.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        <Collapse isOpen={col2} className="accordion-collapse">
                          <div className="accordion-body">
                            ...
                            however that charges 100% will not occur. Charges
                            that may occur fall under part of the compliance
                            statement stating "Message and Data rates may
                            apply."
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        <Collapse isOpen={col3} className="accordion-collapse">
                          <div className="accordion-body">
                            Now that you have a general idea of the amount of
                            texts you will need per month, simply find a plan
                            size that allows you to have this allotment, plus
                            some extra for growth. Don't worry, there are no
                            mistakes to be made here. You can always upgrade and
                            downgrade.
                          </div>
                        </Collapse>
                      </AccordionItem>
                    ...
                    <Accordion id="default-accordion-example" flush>
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            anniversary of your original paid sign up date.
                            Upgrading in the middle of your billing period will
                            not change the billing date. Upgrading does however
                            force an immediate, pro-rated charge to take place
                            on your account.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        <Collapse isOpen={col5} className="accordion-collapse">
                          <div className="accordion-body">
                            If you had signed up on a free account with
                            Slicktext, then upgraded to a paid plan at a later
                            date, your bill will renew based on the date you had
                            upgraded to a paid plan. All invoices are able to be
                            viewed under your plan options in your SlickText
                            account.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        <Collapse isOpen={col6} className="accordion-collapse">
                          <div className="accordion-body">
                            No, we cannot provide this information. Opting out
                            from a list is an anonymous, private act. This
                            prevents further harassment. Providing this
                            information is considered bad practice, and further
                            communication after they opt out would be considered
                            against compliance.
                          </div>
                        </Collapse>
                      </AccordionItem>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>custom-accordionwithicon</code> class to show
                      ...
                      <AccordionItem>
                        <h2 className="accordion-header" id="headingOne">
                          <button
                            ...
                            style={{ cursor: "pointer" }}
                          >
                            <i className="ri-global-line me-2"></i> How Does Age
                            Verification Work?
                          </button>
                        </h2>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            the situation and try, try again until it looks
                            right, and each assumenda labore aes Homo nostrud
                            organic, assumenda labore aesthetic magna elements,
                            buttons, everything.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        <h2 className="accordion-header" id="headingTwo">
                          <button
                            ...
                            style={{ cursor: "pointer" }}
                          >
                            <i className="ri-user-location-line me-2"></i> How
                            Does Link Tracking Work?
                          </button>
                        </h2>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            cursus nunc, quis gravida magna mi a libero. Fusce
                      ...
                      <AccordionItem>
                        <h2 className="accordion-header" id="headingThree">
                          <button
                            ...
                            style={{ cursor: "pointer" }}
                          >
                            <i className="ri-pen-nib-line me-2"></i> How Do I
                            Set Up the Drip Feature?
                          </button>
                        </h2>
                        <Collapse
                          isOpen={iconCol3}
                      ...
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            into this world, and while you have the opportunity
                            to be creative and make your own style choices. For
                            that very reason, I went on a quest and spoke to
                            many different professional graphic designers.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            but a few stray gleams steal into the inner
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>custom-accordionwithicon-plus</code> class to show
                  ...
                  <div className="live-preview">
                    ...
                    >
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            My girl wove six dozen plaid jackets before she
                            quit. Six big devils from Japan quickly forgot how
                            to waltz. try again until it looks right, and each
                            assumenda labore aes Homo nostrud organic, assumenda
                            labore aesthetic magna elements, buttons,
                            everything.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            depending on the situation and try, try again until
                            it looks right, and each letter has the perfect spot
                            of its own. commodo enim craft beer mlkshk aliquip
                            jean shorts ullamco.
                          </div>
                        </Collapse>
                      </AccordionItem>
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            Spacing depending on the situation and try, try
                            again until it looks right, and each. next level wes
                            anderson artisan four loko farm-to-table craft beer
                            twee. commodo enim craft beer mlkshk aliquip jean
                            shorts ullamco. omo nostrud organic, assumenda
                            labore aesthetic magna delectus. pposites attract,
                            and that’s a fact.
                          </div>
                        </Collapse>
                      </AccordionItem>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>lefticon-accordion</code> class to show the icon
                    on the left side of the accordion.
                  </p>
                  <div className="live-preview">
                    <Accordion
                      ...
                      <AccordionItem>
                        ...
                        >
                          <button
                            className={classnames(
                              "accordion-button fw-semibold",
                              { collapsed: !lefticonCol3 }
                            )}
                            type="button"
                            onClick={t_lefticonCol3}
                            style={{ cursor: "pointer" }}
                          >
                            Where does it come from ?
                          </button>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>custom-accordion-border</code> class to create the
                  ...
                  <div className="live-preview">
                    ...
                    >
                      <AccordionItem>
                        ...
                        >
                          <button
                            className={classnames(
                              "accordion-button fw-semibold",
                              { collapsed: !nestingCol1 }
                            )}
                            type="button"
                            onClick={t_nestingCol1}
                            style={{ cursor: "pointer" }}
                          >
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            integrate a different software such Shopify or
                            Hubspot with Slicktext. For example, upon cashing
                            out online, a subscriber may submit to have their
                            mobile number to receive marketing messages. The API
                            will pass this information from said software over
                            to Slicktext via API integration.
                            <div
                              className="accordion nesting2-accordion custom-accordionwithicon accordion-border-box mt-3"
                              ...
                              <AccordionItem>
                                ...
                                >
                                  <button
                                    className={classnames(
                                      "accordion-button fw-semibold",
                                      { collapsed: !anestingCol1 }
                                    )}
                                    type="button"
                                    onClick={t_anestingCol1}
                                    style={{ cursor: "pointer" }}
                                  >
                                ...
                                >
                                  <div className="accordion-body">
                                    ...
                                    SlickText's search navigation tool, located
                                    under the Contacts tab of your Slicktext
                                    account. Once here, you will have options to
                                    sort by, filter, and search your contacts.
                                    <div
                                      className="accordion nesting4-accordion custom-accordionwithicon accordion-border-box mt-3"
                                      ...
                                      <AccordionItem>
                                        ...
                                        >
                                          <button
                                            className={classnames(
                                              "accordion-button fw-semibold",
                                              { collapsed: !bnestingCol1 }
                                            )}
                                            type="button"
                                            onClick={t_bnestingCol1}
                                            style={{ cursor: "pointer" }}
                                          >
                                        ...
                                        <Collapse
                                          isOpen={bnestingCol1}
                                          className="accordion-collapse"
                                          id="accor_nesting4Examplecollapse2"
                                        >
                                          <div className="accordion-body">
                                            Opting out a subscriber will allow
                                            SlickText to maintain the history of
                                            the subscriber as it pertains to the
                                            textword you are opting them out of.
                                            If this user was to text to join
                                            again, the initial text they are met
                                            with will be a "welcome back"
                              ...
                              <AccordionItem>
                                ...
                                >
                                  <button
                                    className={classnames(
                                      "accordion-button fw-semibold",
                                      { collapsed: !anestingCol2 }
                                    )}
                                    type="button"
                                    onClick={t_anestingCol2}
                                    style={{ cursor: "pointer" }}
                                  >
                      ...
                      <AccordionItem>
                        ...
                        >
                          <div className="accordion-body">
                            Personalization allows you to provide a personal
                            touch to your outbound text marketing campaigns.
                            SlickText uses merge tags as placeholders that are
                            replaced with contact-specific information when a
                            text message is sent. These merge tags may also be
                            known as personalization fields.
                            <div
                              className="accordion nesting3-accordion custom-accordionwithicon accordion-border-box mt-3"
                              ...
                              <div className="accordion-item mt-2">
                                ...
                                >
                                  <button
                                    className={classnames(
                                      "accordion-button fw-semibold",
                                      { collapsed: !a1nestingCol1 }
                                    )}
                                    type="button"
                                    onClick={t_a1nestingCol1}
                                    style={{ cursor: "pointer" }}
                                  >
                      ...
                      <AccordionItem>
                        <h2 className="accordion-header" id="headingThree">
                          <button
                            className={classnames(
                              "accordion-button fw-semibold",
                              { collapsed: !nestingCol3 }
                            )}
                            type="button"
                            onClick={t_nestingCol3}
                            style={{ cursor: "pointer" }}
                          >
                        ...
                        >
                          <div className="accordion-body">
                            When you run out of messages, you will not be able
                            to send any outbound campaigns. This would include
                            any scheduled messages, drip campaigns, and birthday
                            messages. However, we will continue to deliver your
                            auto-reply messages to allow your subscriber list to
                            continue to grow.
                          </div>
                        </Collapse>
                      </AccordionItem>
          ...
          <Row>
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>accordion-fill-</code> class with modifier class
                    to the color accordion.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xxl={6}>
                        ...
                        >
                          <AccordionItem>
                            ...
                            >
                              <div className="accordion-body">
                                Webhooks allow you to gather real time data on
                                key interactions that happen with your Slick
                                Text account. Simply provide us with a url where
                                you'd like the data to be sent, choose which
                                events you'd like to be informed of, and click
                                save.{" "}
                              </div>
                            </Collapse>
                          </AccordionItem>
                          <AccordionItem>
                            ...
                            >
                              <div className="accordion-body">
                                Head over to the Textwords page. Click options
                                on the right hand side, and then click Settings.
                                This will redirect you to your Textword Setting
                                page. Now, go check your url, and the textword
                                ID will be the number after "word=". Too much or
                      ...
                      <Col xxl={6}>
                        ...
                        >
                          <AccordionItem>
                            ...
                            >
                              <div className="accordion-body">
                                ...
                                loko farm-to-table craft beer twee. commodo enim
                          ...
                          <AccordionItem>
                            ...
                            >
                              <div className="accordion-body">
                                Consistency is the one thing that can take all
                                of the different elements in your design, and
                                tie them all together and make them work. In an
                                awareness campaign, it is vital for people to
                                begin put 2 and 2 together and begin to
                                recognize your cause. Consistency piques
                                people’s interest.
                              </div>
                            </Collapse>
                          </AccordionItem>
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Here is the example of collapse in which the icon is wrapped
                    within the button collapse toggle.
                  </p>
                  <div className="live-preview">
                    ...
                    <Collapse isOpen={coll6} id="collapseWithicon">
                      <div className="card mb-0">
                        <CardBody>
                          If you enter text including symbols in the search
                          criteria, the search criteria is interpreted exactly
                          as you entered it, and the search is case sensitive as
                          a case insensitive search that contains certain text
                          but does also provide a lot of search criteria
                          options.
                        </CardBody>
                      </div>
                    </Collapse>
                    <Collapse isOpen={coll7} id="collapseWithicon2">
                      <div className="card mb-0 mt-3">
                        <CardBody>
                          When you want to search for data, such as customer
                          names, addresses, or product groups, you enter
                          criteria. In search criteria you can use all the
                          numbers and letters that you normally use in the
                          specific field. In addition, you can use special
                          symbols to further filter the results.
                        </CardBody>
                      </div>
                    </Collapse>
                  </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Inline element collapse takes all horizontal space hence you
                    can activate the collapse within by clicking on full-width
                    horizontal space. Block element collapse can be activated by
                    clicking on collapse toggle only.
                  </p>
                  <div className="live-preview">
                    <div className="mb-3">
                      ...
                      <Col className="col-auto">
                        <Collapse isOpen={coll9} id="collapseinline" horizontal>
                          <div
                            ...
                            style={{ width: "300px" }}
                          >
                            When you have created a new account schedule and set
                            up the rows, you must set up columns.
                          </div>
                        </Collapse>
                      </Col>
                    </Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    selector in its href or data-bs-target attribute. Multiple{" "}
                    <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can
                    show and hide an element if they each reference it with
                    their href or data-bs-target attribute.
                  </p>
                  <div className="live-preview">
                    <div className="d-flex gap-2 flex-wrap mb-3">
                      <Link
