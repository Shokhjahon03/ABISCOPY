...
const UiAlerts = () => {
  ...
  document.title = "Alerts | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>Alert</code> tag to show a default alert.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        <h6>Primary Alert</h6>
                        <Alert color="primary">
                          <strong> Hi! </strong> A simple <b>Primary alert</b>{" "}
                          —check it out!
                        </Alert>
                      ...
                      <Col xl={6}>
                        <h6>Warning Alert</h6>
                        <Alert color="warning">
                          <strong> Uh oh, something went wrong </strong> A
                          simple <b>warning alert</b> —check it out!
                        </Alert>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-borderless</code> class to set alert
                    without border.
                  </p>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert
                          color="danger"
                          className="alert-borderless mb-xl-0"
                        >
                          <strong> Something is very wrong! </strong> A simple
                      ...
                      <Col xl={6}>
                        ...
                        <Alert
                          color="light"
                          className="alert-borderless bg-light"
                        >
                          <strong>Mind Your Step!</strong> A simple{" "}
                          <b>light alert</b> —check it out!
                        </Alert>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>UncontrolledAlert</code> tag to add dismissing
                    button to the alert.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert color="primary">
                          ...
                          <b>Dismissible primary Alert </b> — check it out!
                        </UncontrolledAlert>

                        <h6>Secondary Alert</h6>
                        <UncontrolledAlert color="secondary">
                          <strong> How are you! </strong> A simple{" "}
                          <b>Dismissible secondary alert</b> —check it out!
                        </UncontrolledAlert>

                        <h6>Success Alert</h6>
                        <UncontrolledAlert color="success">
                          <strong>Right Way !</strong> A simple{" "}
                          <b>Dismissible success alert</b> —check it out!
                        </UncontrolledAlert>

                        <h6>Danger Alert</h6>
                        <UncontrolledAlert color="danger" className="mb-xl-0">
                          <strong> Something is very wrong! </strong> A simple{" "}
                          <b>Dismissible danger alert</b> —check it out!
                        </UncontrolledAlert>
                      </Col>
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert color="warning">
                          <strong>Welcome Back!</strong> A simple{" "}
                          <b>Dismissible warning alert</b> —check it out!
                        </UncontrolledAlert>

                        <h6>Info Alert</h6>
                        <UncontrolledAlert color="info">
                          <strong>Don't forget' it !</strong> A simple{" "}
                          <b>Dismissible info alert</b> —check it out!
                        </UncontrolledAlert>

                        <h6>Light Alert</h6>
                        <UncontrolledAlert color="light">
                          <strong>Mind Your Step!</strong> A simple{" "}
                          <b>Dismissible light alert</b> —check it out!
                        </UncontrolledAlert>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-link</code> class at &lt;a&gt; tag to
                    show matching colored links within the given alert.
                  </p>
                  ...
                  <div className="d-none code-view">
                    <pre
                      className="language-markup lang-jsx"
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Click the Show live alert button to show an alert on button
                    click.
                  </p>
                  <div className="live-preview">
                  ...
                  <div className="d-none code-view">
                    <pre
                      className="language-markup language-jsx"
                      style={{ maxHeight: "260px" }}
                    >
                      <code>
                        <LiveExample />
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-outline</code> class to set an alert
                    with outline.
                  </p>
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        >
                          <strong> Hi! </strong> - Outline <b>primary alert</b>{" "}
                          example
                        </UncontrolledAlert>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-outline"
                        >
                          <strong> How are you! </strong> - Outline{" "}
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-outline"
                        >
                          <strong> Yey! Everything worked! </strong> - Outline{" "}
                        ...
                        <UncontrolledAlert
                          color="danger"
                          className="alert-outline mb-xl-0"
                        >
                          <strong> Something is very wrong! </strong> - Outline{" "}
                          <b>danger alert</b> example
                        </UncontrolledAlert>
                      </Col>
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-outline"
                        >
                          <strong>Don't forget' it !</strong> - Outline{" "}
                          <b>info alert</b> example
                        </UncontrolledAlert>
                        ...
                        >
                          <strong>Did you know?</strong> - Outline{" "}
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-border-left </code> class to set an
                    alert with the left border.
                  </p>
                    ...
                    <Row>
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-border-left"
                        >
                          <i className="ri-mail-line me-3 align-middle fs-16"></i>
                          <strong>Light</strong>- Left border alert
                        </UncontrolledAlert>
                        ...
                        >
                          <i className="ri-refresh-line me-3  align-middle fs-16"></i>
                          <strong>Dark</strong>- Left border alert
                        </UncontrolledAlert>
                      </Col>
                    </Row>
                  </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-label-icon</code> class to set an alert
                    with a label icon.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="primary"
                          className="alert-solid alert-label-icon"
                        ...
                        >
                          ...
                          <strong>Secondary</strong>- Label icon alert
                        </UncontrolledAlert>
                        ...
                        >
                          ...
                          <strong>Success</strong>- Label icon alert
                        </UncontrolledAlert>
                        ...
                        >
                          ...
                          <strong>Danger</strong>- Label icon alert
                        </UncontrolledAlert>
                      </Col>
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="dark"
                          className="alert-solid alert-label-icon mb-0"
                          closeClassName="btn-close-white"
                        >
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-additional</code> class and Use the{" "}
                  ...
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          color="danger"
                          className="alert-additional mb-xl-0"
                        >
                          <div className="alert-body">
                            <div className="d-flex">
                              <div className="flex-shrink-0 me-3">
                      ...
                      <Col xl={6}>
                          ...
                          <div className="alert-body">
                            <div className="d-flex">
                              ...
                              <div className="flex-grow-1">
                                ...
                                <p className="mb-0">
                                  This alert needs your attention, but it"s not
                                  super important.
                                </p>
                              </div>
                            </div>
                        ...
                        <UncontrolledAlert
                          color="warning"
                          className="alert-additional mb-0"
                        >
                          <div className="alert-body">
                            <div className="d-flex">
                              <div className="flex-shrink-0 me-3">
                              ...
                              <div className="flex-grow-1">
                                ...
                                <p className="mb-0">
                                  Better check yourself, you're not looking too
                                  good.
                                </p>
                              </div>
                            </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-top-border</code> class to set an alert
                    with the top border and outline.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        >
                          <i className="ri-user-smile-line me-3 align-middle fs-16 text-primary"></i>
                          <strong>Primary</strong>- Top border alert
                        </UncontrolledAlert>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-top-border"
                        >
                          <i className="ri-check-double-line me-3 align-middle fs-16 text-secondary"></i>
                          <strong>Secondary</strong>- Top border alert
                        </UncontrolledAlert>
                      ...
                      <Col xl={6}>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-top-border"
                        >
                          <i className="ri-airplay-line me-3 align-middle fs-16 text-info"></i>
                        ...
                        <UncontrolledAlert
                          ...
                          className="alert-top-border"
                        >
                          <i className="ri-mail-line me-3 align-middle fs-16 text-dark"></i>
                          <strong>Light</strong>- Top border alert
                        </UncontrolledAlert>
                        ...
                        >
                          <i className="ri-refresh-line me-3 align-middle fs-16 text-dark"></i>
                          <strong>Dark</strong>- Top border alert
                        </UncontrolledAlert>
                      </Col>
                    </Row>
                  </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-label-icon label-arrow</code> class to
                    show an alert with label icon and arrow.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-label-icon rounded-label</code> class to
                    set an alert with a rounded label icon.
                  </p>
                  <div className="live-preview">
                    <Row>
                      <Col xl={6}>
                        ...
                        >
                          <i className="ri-check-double-line label-icon"></i>
                          <strong>Secondary</strong>- Rounded label alert
                        </UncontrolledAlert>
                        ...
                        >
                          <i className="ri-notification-off-line label-icon"></i>
                          <strong>Success</strong>- Rounded label alert
                        </UncontrolledAlert>
                        ...
                        >
                          <i className="ri-error-warning-line label-icon"></i>
                          <strong>Danger</strong>- Rounded label alert
                        </UncontrolledAlert>
                      </Col>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>alert-solid</code> class to set an alert with
                    solid style.
                  </p>
                    ...
                    <Row>
                      <Col xl={6}>
                        ...
                        <Alert color="danger" className="alert-solid mb-xl-0">
                          <strong>Something is very wrong!</strong> - Solid{" "}
                          <b>danger alert</b> example
                        </Alert>
                      </Col>
                      ...
                      <Col xl={6}>
                        ...
                        <Alert color="info" className="alert-solid">
                          <strong>Don't forget' it !</strong> - Solid{" "}
                          <b>info alert</b> example
                        </Alert>
