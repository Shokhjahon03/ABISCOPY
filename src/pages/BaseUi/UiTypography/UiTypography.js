...
const UiTypography = () => {
  document.title = "Typography | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
                    ...
                    <Row>
                      <Col sm={6}>
                        <div className="text-muted">
                          ...
                          <div>
                            <p className="display-4 text-dark">Aa</p>
                          </div>
                          <div>
                      ...
                      <Col sm={6}>
                        <div className="text-muted mt-4 mt-sm-0">
                          ...
                          <div>
                            <h1 className="display-4 text-dark ff-secondary">
                              Aa
                            </h1>
                          </div>
                          <div>
                  ...
                  <div className="live-preview">
                    <h1 className="mb-3">
                      ...
                      <small className="text-muted">
                        Semibold 2.03125rem (32.5px)
                      </small>
                    </h1>
                    <h2 className="mb-3">
                      h2. Bootstrap heading{" "}
                      <small className="text-muted">
                        Semibold 1.625rem (26px)
                      </small>
                    </h2>
                    <h3 className="mb-3">
                      h3. Bootstrap heading{" "}
                      <small className="text-muted">
                        Semibold 1.42188rem (22.8px)
                      </small>
                    </h3>
                    <h4 className="mb-3">
                      h4. Bootstrap heading{" "}
                      <small className="text-muted">
                        Semibold 1.21875rem (19.5px)
                      </small>
                    </h4>
                    <h5 className="mb-3">
                      h5. Bootstrap heading{" "}
                      <small className="text-muted">
                        Semibold 1.01563rem (16.25px)
                      </small>
                    </h5>
                    <h6 className="mb-1">
                      h6. Bootstrap heading{" "}
                      <small className="text-muted">
                        Semibold 0.8125rem (13px)
                      </small>
                    </h6>
                  </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>&lt;blockquote className="blockquote"&gt;</code>{" "}
                    class for quoting blocks of content from another source
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted text-muted">
                    Use <code>blockquote-</code> class with the below-mentioned
                    ...
                    <div className="row gy-4">
                      <div className="col-xl-4 col-md-6">
                        <blockquote className="blockquote custom-blockquote blockquote-primary rounded mb-0">
                          ...
                          <footer className="blockquote-footer mt-0">
                            Angie Burt{" "}
                            <cite title="Source Title">Designer</cite>
                          </footer>
                        </blockquote>
                      </div>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted text-muted">
                    Use <code>blockquote-outline</code> class to set blockquote
                    border color.
                  </p>
                  <div className="live-preview">
                    <div className="row gy-4">
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-unstyled</code> class Remove the default
                    list-style and left margin on list items (immediate children
                    only).{" "}
                    <strong>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>list-inline</code> and
                    <code> list-inline-item</code> class combination to remove a
                    list’s bullets and apply some light margin.
                  </p>
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <div className="live-preview">
                    <div>
                      <p className="text-muted">
                        Use <code>text-wrap</code> class to wrap the text.
                      </p>
                      <Badge
                        color="primary"
                        className="text-wrap"
                    ...
                    <div className="mt-4">
                      <p className="text-muted">
                        Use <code>text-nowrap</code> class to prevent text from
                        wrapping.
                      </p>
                      <div
                        className="text-nowrap border bg-light mt-3"
                        style={{ width: "8rem" }}
                      >
                  ...
                  <div className="live-preview">
                    <div>
                      <p className="text-muted">
                        ...
                        strings of text from breaking your components' layout.
                      </p>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>fs-1</code>, <code>fs-2</code>, <code>fs-3</code>,{" "}
                    <code>fs-4</code>, <code>fs-5</code>, or <code>fs-6</code>,
                    class to change the font-size respectively.
                  </p>
                  <div className="live-preview">
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>fst-</code>with modifier class to change
                    font-style and Use <code>fw-</code>with modifier class to
                    change font-weight.
                  </p>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>lh-</code> with modifier class to change the line
                  ...
                  <div className="live-preview">
                    <p className="lh-1">
                      ...
                      Classes are applied to the element itself or sometimes the
                      parent element. These classes can be customized as needed
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>text-lowercase</code>, <code>text-uppercase</code>
                    , or <code>text-capitalize</code> to transform the text.
                  </p>
                  <div className="live-preview">
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>text-decoration-underline</code>,{" "}
                    <code>text-decoration-line-through</code>, or{" "}
                    <code>text-decoration-none</code> class to decorate text in
          ...
          <Row>
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>text-truncate</code> class to truncate the text
                    with an ellipsis. Requires{" "}
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>visible</code> or <code>invisible</code> class to
                  ...
                  <div className="live-preview">
                    ...
                    <div className="invisible">
                      text invisible Lorem ipsum dolor sit amet
                    </div>
                  </div>
                  <div className="d-none code-view">
                    <pre className="language-markup">
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>clearfix</code> class to clear/set floated content
                    within a container.
                  </p>
                  <div className="live-preview">
                    <div className="bg-light clearfix p-3">
                      <Button color="secondary" className="float-start">
