...
const UiGrid = () => {
  document.title = "Grid | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>align-items-start</code> class to vertically
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>align-items-center</code> class to vertically
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>align-items-end</code> class to vertically
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>align-self-start</code>,
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the <code>justify-content-start</code>,
