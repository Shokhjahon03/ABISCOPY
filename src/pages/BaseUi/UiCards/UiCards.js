...
const UiCards = () => {
  ...
  document.title = "Cards | ABMC SCADA - Kibera Technology";
              ...
              <Card>
                ...
                <div className="card-footer">
                  ...
                  <Link to="#" className="card-link link-success">
                    Bookmark{" "}
                    <i className="ri-bookmark-line align-middle ms-1 lh-1"></i>
                  </Link>
                </div>
              </Card>
            </Col>
                  ...
                  <Card>
                    ...
                    <CardBody>
                      ...
                      <p className="card-text text-muted mb-0">
                        ...
                        Miss told ham dull knew see she spot near can. Spirit
                        her entire her called.
                      </p>
                    </CardBody>
                    <div className="card-footer">
                  ...
                  <Card>
                    <CardHeader>
                      ...
                      <h6 className="card-title mb-0">
                        Invoice<span className="text-secondary">#45155468</span>
                      </h6>
                    </CardHeader>
                    <CardBody>
                      <h6 className="card-title">
                      ...
                      <p className="card-text text-muted mb-0">
                        ...
                        real-time potentialities for change for interoperable
                        meta-services itself or distract the viewer's attention
                        from the layout.
                      </p>
                    </CardBody>
                    <div className="card-footer">
          ...
          <Row>
              ...
              <Card>
                <CardBody>
                  <h4 className="card-title mb-3">
                    <i className="ri-user-3-fill align-middle me-1 text-muted"></i>{" "}
                    Natasha Carey
                  </h4>
            ...
            <Col xl={4}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Contrary to popular belief, you don’t have to work endless
                    nights and hours to create a{" "}
                    <Link to="#" className="text-decoration-underline">
                      <b>Fantastic Design</b>
                    </Link>{" "}
                    by using complicated 3D elements. Flat design is your
                    friend. Remember that. And the great thing about flat design
                    is that it has become more and more popular over the years.
                  </p>
                  <p className="text-muted mb-0">
                    In some designs, you might adjust your tracking to create a
                    certain artistic effect.
                  </p>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    tips that you can start implementing. Each design is a new,
                    unique piece of art birthed into this world.
                  </p>
                  <p className="text-muted mb-0">
                ...
                <div className="card-footer">
                  <div className="hstack gap-2 justify-content-end">
                    <Link to="#" className="btn btn-link btn-sm link-success">
                      <i className="ri-close-line align-middle lh-1"></i> Close
                    </Link>
                    <Link to="#" className="btn btn-primary btn-sm">
                      Read More
                    </Link>
                      ...
                      <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                        ...
                        <li className="list-inline-item">
                          <button
                            ...
                            className="btn-close fs-10 align-middle"
                          ></button>
                        </li>
                      </ul>
                    </div>
                ...
                >
                  ...
                  <div className="d-flex mt-2">
                    ...
                    <div className="flex-grow-1 ms-2 text-muted">
                      ...
                      can make things unpleasant for the reader. The goal is to
                      make your text as comfortable to read as possible.
                    </div>
                  </div>
                  <div className="d-flex mt-2">
                    <div className="flex-shrink-0">
                  ...
                  <div className="card-preloader d-none" id="spinner3">
                    <div className="card-status">
                      <img
                        src={spinner1}
                        alt=""
                        className="img-fluid custom-loader"
                      />
                    </div>
                  </div>
                </CardHeader>
                    ...
                    <div className="card-img-overlay p-0 d-flex flex-column">
                      ...
                      <CardBody>
                        <p className="card-text text-white mb-2">
                          ...
                          creative and make your unpleasant for the reader.{" "}
                        </p>
                        <p className="card-text">
                  ...
                  <Card>
                    ...
                    <CardBody>
                      <p className="card-text text-muted">
                        ...
                        Exercitation +1 labore velit, blog sartorial PBR
                        leggings next level wes anderson artisan four loko
                        farm-to-table craft beer twee. ommodo enim craft beer
                        mlkshk aliquip jean shorts ullamco.
                      </p>
                      <p className="card-text mb-0">Last updated 3 mins ago</p>
                    </CardBody>
                      ...
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <p className="card-text">
                            ...
                            (Graphic Designer) started a new conversation.
                          </p>
                        </div>
                      </div>
                    </CardBody>
                  ...
                  <Card className="card-success">
                    <CardBody>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <p className="card-text">
                            <span className="fw-medium">Charles Dickens</span>{" "}
                            (Financial Analyst) started a new conversation.
                          </p>
                        </div>
                      </div>
                    </CardBody>
                  ...
                  <Card className="card-info">
                    <CardBody>
                      <div className="d-flex align-items-center">
                        ...
                        <div className="flex-grow-1 ms-3">
                          <p className="card-text">
                            <span className="fw-medium">Oliver Phillips</span>{" "}
                            (UI/UX Designer) started a new conversation.
                          </p>
                        </div>
                      </div>
                    </CardBody>
              ...
              <Card className="card-warning">
                <CardBody>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <p className="card-text">
                        <span className="fw-medium">Rebecca Swartz</span>{" "}
                        (Graphic Designer) started a new conversation.
                      </p>
                    </div>
                  </div>
              ...
              <Card className="card-danger">
                <CardBody>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <p className="card-text">
                        <span className="fw-medium">Betty Richards</span> (Back
                        End Developer) started a new conversation.
                      </p>
                    </div>
                  </div>
                </CardBody>
              ...
              <Card className="card-dark">
                <CardBody>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <p className="card-text">
                        <span className="fw-medium">Brooke Hayes</span> (Founder
                        & CEO) started a new conversation.
                      </p>
                    </div>
                  </div>
                </CardBody>
              ...
              <Card className="card-secondary">
                <CardBody>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <p className="card-text">
                        <span className="fw-medium">Bethany Johnson</span> (Team
                        Leader) started a new conversation.
                      </p>
                    </div>
                  </div>
                </CardBody>
              ...
              <Card className="card-light">
                <CardBody>
                  <div className="d-flex align-items-center">
                    ...
                    <div className="flex-grow-1 ms-3">
                      <p className="card-text">
                        <span className="fw-medium">Amelie Townsend</span>{" "}
                        (UI/UX Designer) started a new conversation.
                      </p>
                    </div>
                  </div>
                  ...
                  <Card className="border card-border-primary">
                    ...
                    <CardBody>
                      <p className="card-text">
                        ...
                        her. Money witty books nor son add build on the card
                ...
                <Col xxl={4}>
                  <Card className="border card-border-success">
                    ...
                    <CardBody>
                      ...
                      <div className="text-end">
                        <Link to="#" className="link-success fw-medium">
                          Read More{" "}
                          <i className="ri-arrow-right-line align-middle"></i>
                        </Link>
                      </div>
                ...
                <Col xxl={4}>
                  <Card className="border card-border-info">
                    <CardHeader>
                      <h6 className="card-title mb-0">
                        Check your E-mails{" "}
                        <span className="badge bg-info align-middle fs-10">
                          In Process
                        </span>
                      </h6>
                    </CardHeader>
                    <CardBody>
                      ...
                      <div className="text-end">
                        <Link to="#" className="link-info fw-medium">
                          Read More{" "}
                          <i className="ri-arrow-right-line align-middle"></i>
                        </Link>
                      </div>
            ...
            <Col xxl={4}>
              <Card className="border card-border-warning">
                ...
                <CardBody>
                  ...
                  <div className="text-end">
                    <Link to="#" className="link-warning fw-medium">
                      Read More{" "}
                      <i className="ri-arrow-right-line align-middle"></i>
                    </Link>
                  </div>
            ...
            <Col xxl={4}>
              <Card className="border card-border-danger">
                ...
                <CardBody>
                  ...
                  <div className="text-end">
                    <Link to="#" className="link-danger fw-medium">
                      Read More{" "}
                      <i className="ri-arrow-right-line align-middle"></i>
                    </Link>
                  </div>
            ...
            <Col className="col-xxl col-6">
              <Card className="h-100">
                ...
                <CardBody>
                  <p className="card-text">
                    This may be the most commonly encountered tip I received
                    from the designers I spoke with. They highly encourage that
                    you use different fonts in one design, but do not
                    over-exaggerate and go overboard.
                  </p>
                </CardBody>
                <div className="card-footer">
                      ...
                      <div className="d-flex position-relative">
                        ...
                        <div>
                          ...
                          <p>
                            ...
                            real-world content would look like, and we're using
                            it here to give the component a bit of body and
                            size.
                          </p>
                    ...
                    <CardBody>
                      <Row className="g-0 bg-light position-relative">
                        ...
                        <Col md={7} className="p-4">
                          ...
                          <p>
                            Another instance of placeholder content for this
                            other custom component. It is intended to mimic what
                            some real-world content would look like, and we're
