...
const UiUtilities = () => {
  document.title = "Utilities | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      <UiContent />
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use below-mentioned class to an element to easily round its
                    corners.
                  </p>
                  <div className="live-preview">
                    <div>
                      <div>
                        <div className="d-flex align-items-start flex-wrap gap-4">
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md rounded-top"
                              alt="rounded-top"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md rounded-end"
                              alt="rounded-end"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md rounded-bottom"
                              alt="rounded-bottom"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={avatar2}
                              className="avatar-md rounded-start"
                              alt="rounded-start"
                            />
                            <p>
                          ...
                          <div className="text-center">
                            <img
                              src={img2}
                              className="avatar-md w-auto rounded-pill"
                              alt="rounded-pill"
                            />
                            <p>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use below-mentioned class to an element to display the value
                    of components and more with our display utilities.
                  </p>
                  <div className="live-preview">
                    <div>
                      <Row>
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-muted">
                        Change the display value of elements when printing with
                        our print display utility classes.
                      </p>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use the below-mentioned class to an element to custom
                    display the value of components and more with our display
                    utilities.
                  </p>
                  <div className="live-preview">
                    <div>
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-3">
                    Use <code>vstack</code> class to create vertical layouts.
                    Stacked items are full-width by default. Use{" "}
                    <code>gap-</code> class with variation to add space between
                    items.
                  </p>
                  <div className="live-preview">
                    <div className="vstack gap-3">
                      <div className="bg-light border p-1 px-2">First item</div>
                      <div className="bg-light border p-1 px-2">
                        Second item
                      </div>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-3">
                    Use <code>hstack</code> class to create horizontal layouts.
                    Stacked items are full-width by default. Use{" "}
                    <code>gap-</code> class with variation to add space between
                    items.
                  </p>
                  ...
                  <div className="live-preview">
                    ...
                    <div className="mt-4">
                      ...
                      <div className="hstack gap-3">
                        ...
                        <div className="bg-light border p-1 px-2 ms-auto">
                          Second item
                        </div>
                        <div className="bg-light border p-1 px-2">
                          Third item
          ...
          <Row>
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-3">
                    Use <code>pe-none</code> class to prevent and
                  ...
                  <div className="live-preview">
                    <div>
                      ...
                      <p>
                        <Link to="#" className="text-success pe-auto">
                          This link
                        </Link>{" "}
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>overflow</code> property on the fly with four
                      ...
                      <Row>
                        <Col xl={3} sm={6}>
                          <div className="mt-4 mt-xl-0">
                            ...
                            <div className="d-md-flex bg-light">
                              <div
                                className="overflow-auto p-3 mb-0 bg-light"
                                style={{ height: "100px" }}
                              >
                                This is an example of using{" "}
                                <code>.overflow-auto</code>
                                on an element with set width and height
                                dimensions. By design, this content will
                                vertically scroll. Lorem ipsum dolor sit amet,
                        ...
                        <Col xl={3} sm={6}>
                          <div className="mt-4 mt-xl-0">
                            ...
                            <div className="d-md-flex bg-light">
                              <div
                                className="overflow-hidden p-3 mb-0 bg-light"
                                style={{ height: "100px" }}
                              >
                                This is an example of using
                                <code>.overflow-hidden</code> on an element with
                                set width and height dimensions. Lorem ipsum
                        ...
                        <Col xl={3} sm={6}>
                          <div className="mt-4 mt-xl-0">
                            ...
                            <div className="d-md-flex bg-light">
                              <div
                                className="overflow-visible p-3 mb-0 bg-light"
                                style={{ height: "100px" }}
                              >
                                This is an example of using
                                <code>.overflow-visible</code> on an element
                                with set width and height dimensions.Lorem ipsum
                                dolor sit amet, consectetur adipiscing elit, sed
                                do eiusmod tempor incididunt ut labore et dolore
                                magna aliqua.
                              </div>
                        ...
                        <Col xl={3} sm={6}>
                          <div className="mt-4 mt-xl-0">
                            ...
                            <div className="d-md-flex bg-light">
                              <div
                                className="overflow-scroll p-3 mb-0 bg-light"
                                style={{ height: "100px" }}
                              >
                                This is an example of using
                                <code>.overflow-scroll</code> on an element with
                                set width and height dimensions. Lorem ipsum
                                dolor sit amet, consectetur adipiscing elit, sed
                                do eiusmod tempor incididunt ut labore et dolore
                                magna aliqua.
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use
                    <code>w-25</code>,<code>w-50</code>,<code>w-75</code>,
                    <code>w-100</code> or
                    <code>w-auto</code> class to set width <code>25%</code>,{" "}
                    <code>50%</code>,<code>75%</code>, <code>100%</code>, or{" "}
            ...
            <Col xxl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use
                    <code>h-25</code>,<code>h-50</code>,<code>h-75</code>,
                    <code>h-100</code> or
                    <code>h-auto</code> class to set height <code>25%</code>,{" "}
                    <code>50%</code>,<code>75%</code>, <code>100%</code>, or{" "}
                    <code>auto</code> by default respectively.
                  </p>
                  <div className="live-preview">
