...
const LineAwesomeIcons = () => {
  document.title = "Line Awesome Icons | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-accessible-icon"></i> lab
                      la-accessible-icon
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-american-sign-language-interpreting"></i>{" "}
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-audio-description"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-closed-captioning"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-phone-volume"></i> las
                      la-phone-volume
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-question-circle"></i> las
                      la-question-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sign-language"></i> las
                      la-sign-language
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-universal-access"></i> las
                      la-universal-acces
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="row icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-exclamation-circle"></i> las
                      la-exclamation-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-exclamation-triangle"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-radiation-alt"></i> las
                      la-radiation-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-skull-crossbones"></i> las
                      la-skull-crossbones
                    </Col>
                  </Row>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-angle-double-down"></i>las
                      la-angle-double-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-angle-double-left"></i>las
                      la-angle-double-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-angle-double-right"></i>las
                      la-angle-double-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-angle-double-up"></i>las
                      la-angle-double-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-alt-circle-down"></i>las
                      la-arrow-alt-circle-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-alt-circle-left"></i>las
                      la-arrow-alt-circle-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-alt-circle-right"></i>las
                      la-arrow-alt-circle-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-alt-circle-up"></i>las
                      la-arrow-alt-circle-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-circle-down"></i> las
                      la-arrow-circle-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-circle-left"></i> las
                      la-arrow-circle-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-circle-right"></i> las
                      la-arrow-circle-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrow-circle-up"></i> las
                      la-arrow-circle-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrows-alt-h"></i> las
                      la-arrows-alt-h
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-arrows-alt-v"></i> las
                      la-arrows-alt-v
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-caret-square-down"></i> las
                      la-caret-square-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-caret-square-left"></i> las
                      la-caret-square-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-caret-square-right"></i> las
                      la-caret-square-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-caret-square-up"></i> las
                      la-caret-square-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cart-arrow-down"></i> las
                      la-cart-arrow-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-circle-down"></i> las
                      la-chevron-circle-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-circle-left"></i> las
                      la-chevron-circle-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-circle-right"></i> las
                      la-chevron-circle-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-circle-up"></i> las
                      la-chevron-circle-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-down"></i> las
                      la-chevron-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-left"></i> las
                      la-chevron-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chevron-right"></i> las
                      la-chevron-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-download-alt"></i> las
                      la-cloud-download-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-upload-alt"></i> las
                      la-cloud-upload-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-compress-arrows-alt"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-exchange-alt"></i> las
                      la-exchange-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-expand-arrows-alt"></i> las
                      la-expand-arrows-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-external-link-alt"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-point-down"></i> las
                      la-hand-point-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-point-left"></i> las
                      la-hand-point-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-point-right"></i> las
                      la-hand-point-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-point-up"></i> las
                      la-hand-point-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-pointer"></i> las
                      la-hand-pointer
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-level-down-alt"></i> las
                      la-level-down-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-level-up-alt"></i> las
                      la-level-up-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-location-arrow"></i> las
                      la-location-arrow
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-long-arrow-alt-down"></i> las
                      la-long-arrow-alt-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-long-arrow-alt-left"></i> las
                      la-long-arrow-alt-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-long-arrow-alt-right"></i> las
                      la-long-arrow-alt-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-long-arrow-alt-up"></i> las
                      la-long-arrow-alt-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-mouse-pointer"></i> las
                      la-mouse-pointer
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-share-square"></i> las
                      la-share-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sign-out-alt"></i> las
                      la-sign-out-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-alpha-down"></i> las
                      la-sort-alpha-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-alpha-down-alt"></i> las
                      la-sort-alpha-down-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-alpha-up"></i> las
                      la-sort-alpha-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-alpha-up-alt"></i> las
                      la-sort-alpha-up-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-amount-down"></i> las
                      la-sort-amount-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-amount-down-alt"></i> las
                      la-sort-amount-down-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-amount-up"></i> las
                      la-sort-amount-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-amount-up-alt"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-numeric-down"></i> las
                      la-sort-numeric-down
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-numeric-down-alt"></i> las
                      la-sort-numeric-down-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-numeric-up"></i> las
                      la-sort-numeric-up
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sort-numeric-up-alt"></i> las
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-broadcast-tower"></i> las
                      la-broadcast-tower
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-fast-backward"></i> las
                      la-fast-backward
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-fast-forward"></i> las
                      la-fast-forward
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-microphone-alt"></i> las
                      la-microphone-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-microphone-alt-slash"></i> las
                      la-microphone-alt-slash
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-microphone-slash"></i> las
                      la-microphone-slash
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-pause-circle"></i> las
                      la-pause-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-phone-volume"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-step-backward"></i> las
                      la-step-backward
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-step-forward"></i> las
                      la-step-forward
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-air-freshener"></i> las
                      la-air-freshener
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-charging-station"></i> las
                      la-charging-station
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-tachometer-alt"></i> las
                      la-tachometer-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-truck-monster"></i> las
                      la-truck-monster
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-truck-pickup"></i> las
                      la-truck-pickup
                    </Col>
                  </Row>
                  <h6 className="text-uppercase text-muted fw-semibold mt-4">
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-drumstick-bite"></i> las
                      la-drumstick-bite
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-football-ball"></i> las
                      la-football-ball
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-glass-cheers"></i> las
                      la-glass-cheers
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-glass-martini"></i> las
                      la-glass-martini
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-glass-martini-alt"></i> las
                      la-glass-martini-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-glass-whiskey"></i> las
                      la-glass-whiskey
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-wine-glass-alt"></i>las
                      la-wine-glass-alt
                    </Col>
                  </Row>
                  <h6 className="text-uppercase text-muted fw-semibold mt-4">
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-affiliatetheme"></i> lab
                      la-affiliatetheme
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-angrycreative"></i> lab
                      la-angrycreative
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-app-store-ios"></i> lab
                      la-app-store-ios
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-autoprefixer"></i> lab
                      la-autoprefixer
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-behance-square"></i> lab
                      la-behance-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-buromobelexperte"></i> lab
                      la-buromobelexperte
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-canadian-maple-leaf"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cloudversify"></i> lab
                      la-cloudversify
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-connectdevelop"></i> lab
                      la-connectdevelop
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cotton-bureau"></i> lab
                      la-cotton-bureau
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons"></i>lab
                      la-creative-commons
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-by"></i>lab
                      la-creative-commons-by
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-nc"></i>lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-nd"></i>lab
                      la-creative-commons-nd
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-pd"></i>lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-sa"></i>lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-creative-commons-zero"></i>lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-digital-ocean"></i> lab
                      la-digital-ocean
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-draft2digital"></i> lab
                      la-draft2digital
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-dribbble-square"></i> lab
                      la-dribbble-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-expeditedssl"></i> lab
                      la-expeditedssl
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-facebook-messenger"></i> lab
                      la-facebook-messenger
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-facebook-square"></i> lab
                      la-facebook-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-first-order-alt"></i> lab
                      la-first-order-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-font-awesome"></i> lab
                      la-font-awesome
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-font-awesome-alt"></i> lab
                      la-font-awesome-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-font-awesome-flag"></i> lab
                      la-font-awesome-flog
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-fonticons"></i> lab la-fonticons
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-fonticons-fi"></i> lab
                      la-fonticons-fi
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-fort-awesome"></i> lab
                      la-fort-awesome
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-fort-awesome-alt"></i> lab
                      la-fort-awesome-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-free-code-camp"></i> lab
                      la-free-code-camp
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-github-square"></i>lab
                      la-github-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-google-plus-g"></i>lab
                      la-google-plus-g
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-google-plus-square"></i>lab
                      la-google-plus-squar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-hacker-news-square"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-hire-a-helper"></i> lab
                      la-hire-a-helper
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-internet-explorer"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-kickstarter-k"></i> lab
                      la-kickstarter-
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-lastfm-square"></i> lab
                      la-lastfm-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-odnoklassniki"></i> lab
                      la-odnoklassniki
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-odnoklassniki-square"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-optin-monster"></i> lab
                      la-optin-monster
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-phoenix-framework"></i> lab
                      la-phoenix-framework
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-phoenix-squadron"></i> lab
                      la-phoenix-squadron
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-pied-piper-alt"></i> lab
                      la-pied-piper-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-pied-piper-hat"></i> lab
                      la-pied-piper-hat
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-pied-piper-pp"></i> lab
                      la-pied-piper-pp
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-pinterest-square"></i> lab
                      la-pinterest-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-product-hunt"></i> lab
                      la-product-hunt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-reddit-square"></i>lab
                      la-reddit-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-researchgate"></i> lab
                      la-researchgate
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-servicestack"></i> lab
                      la-servicestack
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-shirtsinbulk"></i> lab
                      la-shirtsinbulk
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-snapchat-ghost"></i> lab
                      la-snapchat-ghos
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-snapchat-square"></i> lab
                      la-snapchat-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-speaker-deck"></i> lab
                      la-speaker-deck
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-stack-exchange"></i> lab
                      la-stack-exchange
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-stack-overflow"></i> lab
                      la-stack-overflow
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-sticker-mule"></i> lab
                      la-sticker-mule
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-studiovinari"></i> lab
                      la-studiovinari
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-stumbleupon-circle"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-telegram-plane"></i> lab
                      la-telegram-plane
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-tencent-weibo"></i> lab
                      la-tencent-weibo
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-the-red-yeti"></i> lab
                      la-the-red-yeti
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-trade-federation"></i> lab
                      la-trade-federation
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-tumblr-square"></i> lab
                      la-tumblr-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-twitter-square"></i>lab
                      la-twitter-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-viadeo-square"></i> lab
                      la-viadeo-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-vimeo-square"></i> lab
                      la-vimeo-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-whatsapp-square"></i> lab
                      la-whatsapp-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-wolf-pack-battalion"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-wordpress-simple"></i> lab
                      la-wordpress-simple
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-y-combinator"></i> lab
                      la-y-combinator
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-yandex-international"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-youtube-square"></i> lab
                      la-youtube-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-clinic-medical"></i> las
                      la-clinic-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hospital-alt"></i> las
                      la-hospital-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-house-damage"></i> las
                      la-house-damage
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-place-of-worship"></i> las
                      la-place-of-worship
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-address-book"></i> las
                      la-address-book
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-address-card"></i> las
                      la-address-card
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-balance-scale"></i> las
                      la-balance-scale
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-balance-scale-left"></i> las
                      la-balance-scale-left
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-balance-scale-right"></i> las
                      la-balance-scale-right
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-birthday-cake"></i> las
                      la-birthday-cake
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-business-time"></i> las
                      la-business-tim
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-alt"></i> las
                      la-calendar-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-envelope-open"></i> las
                      la-envelope-open
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-envelope-square"></i> las
                      la-envelope-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-folder-minus"></i> las
                      la-folder-minus"
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-phone-square"></i> las
                      la-phone-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-phone-square-alt"></i> las
                      la-phone-square-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-phone-volume"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-project-diagram"></i> las
                      la-project-diagram
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-toilet-paper"></i> las
                      la-toilet-paper
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-tree"></i> las la-tree
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-holding-heart"></i> las
                      la-hand-holding-heart
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-holding-usd"></i> las
                      la-hand-holding-usd
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hands-helping"></i> las
                      la-hands-helping
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-parachute-box"></i> las
                      la-parachute-box
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-comment-dots"></i> las
                      la-comment-dots
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-comment-medical"></i> las
                      la-comment-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-comment-slash"></i> las
                      la-comment-slash
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chess-bishop"></i> las
                      la-chess-bishop
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chess-knight"></i> las
                      la-chess-knight
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-baby-carriage"></i> las
                      la-baby-carriage
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-graduation-cap"></i> las
                      la-graduation-cap
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hat-cowboy-side"></i> las
                      la-hat-cowboy-side
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-fire-extinguisher"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-window-close"></i> las
                      la-window-close
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-window-maximize"></i> las
                      la-window-maximize
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-window-minimize"></i> las
                      la-window-minimize
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-window-restore"></i> las
                      la-window-restore
                    </Col>
                  </Row>
                  <h6 className="text-uppercase text-muted fw-semibold mt-4">
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-satellite-dish"></i> las
                      la-satellite-dish
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-save"></i> las la-save
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-drafting-compass"></i> las
                      la-drafting-compass
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-paint-roller"></i> las
                      la-paint-roller
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-pencil-alt"></i> las la-pencil-alt
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-pencil-ruler"></i> las
                      la-pencil-ruler
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-ruler-combined"></i> las
                      la-ruler-combined
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-ruler-horizontal"></i> las
                      la-ruler-horizontal
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-ruler-vertical"></i> las
                      la-ruler-vertical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-money-bill-alt"></i> las
                      la-money-bill-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-money-bill-wave"></i> las
                      la-money-bill-wave
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-money-bill-wave-alt"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-money-check-alt"></i> las
                      la-money-check-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-check"></i> las
                      la-calendar-check
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-minus"></i> las
                      la-calendar-minus
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-plus"></i> las
                      la-calendar-plus
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-times"></i> las
                      la-calendar-times
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hourglass-end"></i> las
                      la-hourglass-end
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hourglass-half"></i> las
                      la-hourglass-half
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hourglass-start"></i> las
                      la-hourglass-start
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-bezier-curve"></i> las
                      la-bezier-curve
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-brush"></i> las la-brush
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-draw-polygon"></i> las
                      la-draw-polygon
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-edit"></i> las la-edit
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-object-group"></i> las
                      la-object-group
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-object-ungroup"></i> las
                      la-object-ungroup
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-vector-square"></i> las
                      la-vector-square
                    </Col>
                  </Row>
                  ...
                  <Row className="icon-demo-content">
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-align-center"></i> las
                      la-align-center
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-align-justify"></i> las
                      la-align-justify
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-border-style"></i> las
                      la-border-style
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-clipboard"></i> las la-clipboard
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-strikethrough"></i> las
                      la-strikethrough
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-trash-restore"></i> las
                      la-trash-restore
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-trash-restore-alt"></i> las
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chalkboard-teacher"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-theater-masks"></i> las
                      la-theater-masks
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-graduate"></i> las
                      la-user-graduate
                    </Col>
                  </Row>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grin-beam-sweat"></i> las
                      la-grin-beam-sweat
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grin-squint-tears"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grin-tongue-squint"></i> las
                      la-grin-tongue-squint
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grin-tongue-wink"></i> las
                      la-grin-tongue-wink
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-kiss-wink-heart"></i> las
                      la-kiss-wink-heart
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-meh-rolling-eyes"></i> las
                      la-meh-rolling-eyes
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-battery-empty"></i> las
                      la-battery-empty
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-battery-full"></i> las
                      la-battery-full
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-battery-half"></i> las
                      la-battery-half
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-battery-quarter"></i> las
                      la-battery-quarter
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-archive"></i> las
                      la-file-archive
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-audio"></i> las la-file-audio
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-powerpoint"></i> las
                      la-file-powerpoint
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-video"></i> las la-file-video
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cash-register"></i> las
                      la-cash-register
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chart-line"></i> las la-chart-line
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-comment-dollar"></i> las
                      la-comment-dollar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-comments-dollar"></i> las
                      la-comments-dollar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-invoice"></i> las
                      la-file-invoice
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-invoice-dollar"></i> las
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-meatball"></i> las
                      la-cloud-meatball
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cookie"></i> las la-cookie
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-puzzle-piece"></i> las
                      la-puzzle-piece
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-steam-square"></i> lab
                      la-steam-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-steam-symbol"></i> lab
                      la-steam-symbol
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-mars-stroke-h"></i> las
                      la-mars-stroke-h
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-mars-stroke-v"></i> las
                      la-mars-stroke-v
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-transgender-alt"></i> las
                      la-transgender-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-venus-double"></i> las
                      la-venus-double
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-holding"></i> las
                      la-hand-holding
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-holding-heart"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-middle-finger"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hand-scissors"></i> las
                      la-hand-scissors
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-praying-hands"></i> las
                      la-praying-hands
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-prescription"></i> las
                      la-prescription
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-concierge-bell"></i> las
                      la-concierge-bell
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dice"></i> las la-dice
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-luggage-cart"></i> las
                      la-luggage-cart
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-suitcase-rolling"></i> las
                      la-suitcase-rolling
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-swimming-pool"></i> las
                      la-swimming-pool
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-tv"></i> las la-tv
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-umbrella-beach"></i> las
                      la-umbrella-beach
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-camera-retro"></i> las
                      la-camera-retro
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-chalkboard"></i> las la-chalkboard
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-check-circle"></i> las
                      la-check-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-check-double"></i> las
                      la-check-double
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-check-square"></i> las
                      la-check-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-circle"></i> las la-circle
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-download"></i> las
                      la-file-download
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-flag-checkered"></i> las
                      la-flag-checkered
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-folder"></i> las la-folder
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grip-horizontal"></i> las
                      la-grip-horizontal
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grip-lines-vertical"></i> las
                      la-grip-lines-vertical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-grip-vertical"></i> las
                      la-grip-vertical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-minus-circle"></i> las
                      la-minus-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-minus-square"></i> las
                      la-minus-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-paste"></i> las la-paste
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-search-minus"></i> las
                      la-search-minus
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-share-alt-square"></i> las
                      la-share-alt-square
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-share-square"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-times-circle"></i> las
                      la-times-circle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-clipboard-check"></i> las
                      la-clipboard-check
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-clipboard-list"></i> las
                      la-clipboard-list
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dolly-flatbed"></i> las
                      la-dolly-flatbed
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hard-hat"></i> las la-hard-hat
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shipping-fast"></i> las
                      la-shipping-fast
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-truck"></i> las la-truck
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-map-marker-alt"></i> las
                      la-map-marker-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shopping-bag"></i> las
                      la-shopping-bag
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shopping-basket"></i> las
                      la-shopping-basket
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shopping-cart"></i> las
                      la-shopping-cart
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shower"></i> las la-shower
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-traffic-light"></i> las
                      la-traffic-light
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-utensil-spoon"></i> las
                      la-utensil-spoon
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-utensils"></i> las la-utensils
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dharmachakra"></i> las
                      la-dharmachakra
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-frog"></i> las la-frog
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      3<i className="las la-comments-dollar"></i> las
                      la-comments-dollar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-envelope-open-text"></i> las
                      la-envelope-open-text
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-funnel-dollar"></i> las
                      la-funnel-dollar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-lightbulb"></i> las la-lightbulb
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-search-dollar"></i> las
                      la-search-dollar
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-search-location"></i> las
                      la-search-location
                    </Col>
                  </Row>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-greater-than"></i> las
                      la-greater-than
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-greater-than-equal"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-less-than-equal"></i> las
                      la-less-than-equal
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-minus"></i> las la-minus
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-square-root-alt"></i> las
                      la-square-root-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-subscript"></i> las la-subscript
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-book-medical"></i> las
                      la-book-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-briefcase-medical"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-medical"></i> las
                      la-file-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-medical-alt"></i> las
                      la-file-medical-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-prescription"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hospital-symbol"></i> las
                      la-hospital-symbol
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-laptop-medical"></i> las
                      la-laptop-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-microscope"></i> las la-microscope
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-mortar-pestle"></i> las
                      la-mortar-pestle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-notes-medical"></i> las
                      la-notes-medical
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-prescription-bottle"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-star-of-life"></i> las
                      la-star-of-life
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-stethoscope"></i> las la-stethoscope
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-people-carry"></i> las
                      la-people-carry
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-route"></i> las la-route
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-truck-loading"></i> las
                      la-truck-loading
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-truck-moving"></i> las
                      la-truck-moving
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-wine-glass"></i> las la-wine-glass
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-drum-steelpan"></i> las
                      la-drum-steelpan
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-audio"></i> las la-file-audio
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-headphones-alt"></i> las
                      la-headphones-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-microphone"></i> las la-microphone
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-record-vinyl"></i> las
                      la-record-vinyl
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-sliders-h"></i> las la-sliders-h
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-digital-tachograph"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-heart-broken"></i> las
                      la-heart-broken
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-helicopter"></i> las la-helicopter
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-space-shuttle"></i> las
                      la-space-shuttle
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-star"></i> las la-star
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-blender-phone"></i> las
                      la-blender-phone
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-blogger"></i> lab la-blogger
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dumpster-fire"></i> las
                      la-dumpster-fire
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-dyalog"></i> lab la-dyalog
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-google-drive"></i> lab
                      la-google-drive
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-google-play"></i> lab la-google-play
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-network-wired"></i> las
                      la-network-wired
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-nimblr"></i> lab la-nimblr
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-raspberry-pi"></i> lab
                      la-raspberry-pi
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-ravelry"></i> lab la-ravelry
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-reddit-alien"></i> lab
                      la-reddit-alien
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-reddit-square"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-vr-cardboard"></i> las
                      la-vr-cardboard
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-vuejs"></i> lab la-vuejs
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-weight-hanging"></i> las
                      la-weight-hanging
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-weixin"></i> lab la-weixin
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cc-amazon-pay"></i> lab
                      la-cc-amazon-pay
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cc-apple-pay"></i> lab
                      la-cc-apple-pay
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cc-diners-club"></i> lab
                      la-cc-diners-club
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-cc-mastercard"></i> lab
                      la-cc-mastercard
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-google-wallet"></i> lab
                      la-google-wallet
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-handshake"></i> las la-handshake
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-person-booth"></i> las
                      la-person-booth
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-piggy-bank"></i> las la-piggy-bank
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-journal-whills"></i> las
                      la-journal-whills
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-kaaba"></i> las la-kaaba
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-pastafarianism"></i> las
                      la-pastafarianism
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-star-and-crescent"></i> las
                      la-star-and-crescent
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-star-of-david"></i> las
                      la-star-of-david
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-synagogue"></i> las la-synagogue
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-temperature-high"></i> las
                      la-temperature-high
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-temperature-low"></i> las
                      la-temperature-low
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-vial"></i> las la-vial
                  ...
                  <Row>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-galactic-republic"></i> lab
                      la-galactic-republic
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-galactic-senate"></i> lab
                      la-galactic-senate
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-globe"></i> las la-globe
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-old-republic"></i> lab
                      la-old-republic
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-robot"></i> las la-robot
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-astronaut"></i> las
                      la-user-astronaut
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-contract"></i> las
                      la-file-contract
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-file-signature"></i> las
                      la-file-signature
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-fingerprint"></i> las la-fingerprint
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-friends"></i> las
                      la-user-friends
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-circle-notch"></i> las
                      la-circle-notch
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cog"></i> las la-cog
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-compact-disc"></i> las
                      la-compact-disc
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-compass"></i> las la-compass
                  ...
                  <Row>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-baseball-ball"></i> las
                      la-baseball-ball
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-basketball-ball"></i> las
                      la-basketball-ball
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-biking"></i> las la-biking
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-bowling-ball"></i> las
                      la-bowling-ball
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dumbbell"></i> las la-dumbbell
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-skiing-nordic"></i> las
                      la-skiing-nordic
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-snowboarding"></i> las
                      la-snowboarding
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-swimmer"></i> las la-swimmer
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-table-tennis"></i> las
                      la-table-tennis
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-volleyball-ball"></i> las
                      la-volleyball-ball
                    </Col>
                  </Row>
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-sun-rain"></i> las
                      la-cloud-sun-rain
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-frog"></i> las la-frog
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-day"></i> las
                      la-calendar-day
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-minus"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-calendar-week"></i> las
                      la-calendar-week
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cart-arrow-down"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-star-half-alt"></i> las
                      la-star-half-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-stream"></i> las la-stream
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-thermometer-empty"></i> las
                      la-thermometer-empty
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-thermometer-full"></i> las
                      la-thermometer-full
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-thermometer-half"></i> las
                      la-thermometer-half
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-thermometer-quarter"></i> las
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-alt-slash"></i> las
                      la-user-alt-slash
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-critical-role"></i> lab
                      la-critical-role
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-d-and-d-beyond"></i> lab
                      la-d-and-d-beyond
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-dice-d20"></i> las la-dice-d20
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-fantasy-flight-games"></i> lab
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-penny-arcade"></i> lab
                      la-penny-arcade
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-ring"></i> las la-ring
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="lab la-wizards-of-the-coast"></i> lab
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-globe-africa"></i> las
                      la-globe-africa
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-globe-americas"></i> las
                      la-globe-americas
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-globe-europe"></i> las
                      la-globe-europe
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-hot-tub"></i> las la-hot-tub
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-map-marked-alt"></i> las
                      la-map-marked-alt
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-monument"></i> las la-monument
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-plane-arrival"></i> las
                      la-plane-arrival
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-plane-departure"></i> las
                      la-plane-departure
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-shuttle-van"></i> las la-shuttle-van
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-injured"></i> las
                      la-user-injured
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-user-lock"></i> las la-user-lock
                  ...
                  <Row>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-moon-rain"></i> las
                      la-cloud-moon-rain
                    </Col>
                    <Col xl={3} lg={4} sm={6}>
                    ...
                    <Col xl={3} lg={4} sm={6}>
                      <i className="las la-cloud-showers-heavy"></i> las
