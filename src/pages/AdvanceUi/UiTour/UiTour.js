...
const UiTour = () => {
  document.title = "Tour | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
                ...
                <Card>
                  ...
                  <CardBody>
                    <p className="text-muted mb-4">
                      Use when you want to help users along getting accustomed
                      to your user interface or Use when you want to notify your
                      users of new or unfamiliar features.
                    </p>
                    ...
                    <div>
                      <Row className="justify-content-center">
                        <Col lg={5}>
                          <div className="text-center mt-4 mb-5">
                            <div
                              className="py-3 px-2 d-inline-block"
                              id="logo-tour"
                            >
                              <img
                                src={logodark}
                            ...
                            <p className="text-muted">
                              ...
                              vulputate lacus. Suspendisse ultricies mi eros,
                              sit amet tempor nulla varius sed dapibus in
                              tellus.
                            </p>
                      ...
                      <div className="text-center my-4">
                        <Button color="success" id="thankyou-tour">
                          Thank you !
                        </Button>
                      </div>
                    </div>
