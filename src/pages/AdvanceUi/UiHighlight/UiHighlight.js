...
import {
  ...
  CssHighlightExample,
  JavaScriptExample,
} from "./UiHighlightCode";

const UiHighlight = () => {
  document.title = "Highlight | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    property, relevance, or special interest to an HTML
                    document. here is the example shown below.
                  </p>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    ...
                    property, relevance, or special interest to a CSS document.
          ...
          <Row>
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Javascript highlight is used to mark or highlight text that
                    is of property, relevance, or special interest to a
                    Javascript document. Here is the example shown below.
                  </p>
                  <div className="live-preview">
                    <pre>
