...
const UiRatings = () => {
  ...
  document.title = "Ratings | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Rater-js is a star rating widget for the browser. here are
                    the various examples of rating shown below with variation.
                  </p>
                    ...
                    <div className="table-responsive">
                      <table className="table align-middle mb-0">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <th scope="row">
                              Example with unlimited number of stars. readOnly
                            ...
                            <td>
                              <div dir="ltr">
                                ...
                                <Button
                                  ...
                                  className="ms-2"
                                  onClick={() =>
                                    setreset("mdi mdi-star-outline text-muted ")
                                  }
                                >
                                  Reset
                                </Button>
                  ...
                  <div className="d-none code-view">
                    <pre>
                      <code className="language-markup">
                        &lt;div data-simplebar style=&quot;max-height:
                        220px;&quot;&gt; ... &lt;/div&gt;
                      </code>
                    </pre>
                  </div>
