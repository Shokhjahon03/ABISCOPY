...
const UiScrollbar = () => {
  document.title = "Scrollbar | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
          ...
          <Row>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>SimpleBar</code> attribute and add{" "}
                  ...
                  <div className="mx-n3">
                    <SimpleBar style={{ maxHeight: "220px" }} className="px-3">
                      ...
                      <p>
                        ...
                        what Occidental is. The European languages are members
                      ...
                      <p>
                        ...
                        achieve this, it would be necessary to have uniform
            ...
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>autoHide={false}</code> attribute and add{" "}
          ...
          <Row>
            <Col xl={6}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted">
                    Use <code>data-simplebar-direction="rtl"</code> attribute
                    and add <code>max-height: **px</code> to set simplebar at
                    right side.
                  </p>
              ...
              <Row>
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="primary"</code>{" "}
                        attribute to set primary color simplebar track.
                      </p>
                        ...
                        >
                          ...
                          >
                            <div className="d-flex">
                              ...
                              <div className="flex-shrink-0 ms-2">
                                <div className="fs-11 text-muted">
                                  <i className="mdi mdi-clock-outline"></i> 01
                                  hr ago
                                </div>
                              </div>
                            </div>
                          ...
                          >
                            <div className="d-flex">
                              ...
                              <div className="flex-shrink-0 ms-2">
                                <div className="fs-11 text-muted">
                                  <i className="mdi mdi-clock-outline"></i> 02
                                  hrs ago
                                </div>
                              </div>
                            </div>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="secondary"</code>{" "}
                        attribute to set secondary color simplebar track.
                      </p>
                      ...
                      <div className="mx-n3">
                        ...
                        >
                          <div className="list-group list-group-flush">
                            <Link
                              to="#"
                              className="list-group-item text-muted py-3"
                            >
                              <div className="d-flex align-items-start">
                                ...
                                <div className="flex-grow-1 overflow-hidden">
                                  <h5 className="text-truncate fs-13 mb-1">
                                    Michael Johnston
                                  </h5>
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="success"</code>{" "}
                        attribute to set success color simplebar track.
                      </p>

                      <div className="mx-n3">
                        <SimpleBar
                          autoHide={false}
                          className="simplebar-track-success"
                          style={{ maxHeight: "275px" }}
                        >
                            ...
                            <li className="list-group-item py-3">
                              <div className="d-flex align-items-center">
                                ...
                                <div className="flex-grow-1 text-muted overflow-hidden">
                                  <h5 className="text-truncate fs-14 mb-1">
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="info"</code> attribute
                        to set info color simplebar track.
                      </p>

                      <div className="mx-n3">
                        <SimpleBar
                          autoHide={false}
                          className="simplebar-track-info"
                          style={{ maxHeight: "220px" }}
                        >
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="warning"</code>{" "}
                        attribute to set warning color simplebar track.
                      </p>
                      ...
                      <div className="mx-n3">
                        <SimpleBar
                          autoHide={false}
                          style={{ maxHeight: "220px" }}
                          className="simplebar-track-warning px-3"
                        >
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="danger"</code> attribute
                        to set danger color simplebar track.
                      </p>
                      ...
                      <div className="mx-n3">
                        <SimpleBar
                          autoHide={false}
                          style={{ maxHeight: "220px" }}
                          className="simplebar-track-danger px-3"
                        >
                          <Link
                            to="#"
                ...
                <Col xl={4} lg={6}>
                  <Card>
                    ...
                    <CardBody>
                      <p className="text-muted">
                        Use <code>data-simplebar-track="dark"</code> attribute
                        to set dark color simplebar track.
                      </p>

                      <div className="mx-n3">
                        <SimpleBar
                          autoHide={false}
                          className="simplebar-track-dark"
                          style={{ maxHeight: "220px" }}
                        >
                          <ul className="list-group list-group-flush">
                            <li className="list-group-item">
                              <div>
                                ...
                                <p className="text-muted mb-4">
                                  It will be as simple as in fact, It will seem
                                  like simplified
                                </p>
                                <div className="d-flex align-items-start">
                                  <div className="flex-grow-1">
