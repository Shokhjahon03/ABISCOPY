...
const District = () => {
  ...
  const handleEdite = async (e) => {
    ...
    const response = await editdistrictAsync(`district`, {
      ...dataDocument,
      id: current?.id,
    });
    if (response?.errorCode) {
  ...
  document.title = "Regions | ABMC SCADA - Kibera Technology";
  return (
    <React.Fragment>
      {/* <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Районы" pageTitle="Директория" /> */}
      <Row>
        <Col lg={12}>
          <Card>
            <CardBody>
                  ...
                  >
                    <thead className="table-light">
                      <tr>
                        ...
                        <th className="text-center">Код района</th>
                        <th className="text-center">Область</th>
                    ...
                    <tbody className="list form-check-all">
                      {districts?.map((res, i) => (
                        <tr key={res?.id}>
                          ...
                          <td>{res?.name}</td>
                          <td className="text-center">{res?.districtCode}</td>
                          <td className="text-center">{res?.region?.name}</td>
          ...
          <ModalBody>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                defaultValue={current?.districtCode}
                required
              />
            </div>
            <div className="mb-3">
              ...
              <Input
                ...
                className="form-control"
                name="region"
                defaultValue={current?.region?.name}
                required
              >
                {regions?.map((res) => (
