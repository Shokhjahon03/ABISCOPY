...
const Region = () => {
  ...
  const handleEdite = async (e) => {
    ...
    const response = await editregionAsync(`region`, {
      ...dataDocument,
      id: current?.id,
    });
    if (response?.errorCode) {
  ...
  return (
    <React.Fragment>
      {/* <div className="page-content">
                <Container fluid>
                    <BreadCrumb title="Область" pageTitle="Директория" /> */}
      <Row>
        <Col lg={12}>
          <Card>
            <CardBody>
                    ...
                    <tbody className="list form-check-all">
                      {regions?.map((res, i) => (
                        <tr key={res?.id}>
                          ...
                          <td>{res?.name}</td>
                          <td className="text-center">{res?.regionCode}</td>
          ...
          <ModalBody>
            ...
            <div className="mb-3">
              ...
              <input
                ...
                defaultValue={current?.regionCode}
                required
              />
            </div>
          </ModalBody>
