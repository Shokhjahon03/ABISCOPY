...
import RolesAndPermissions from "../pages/Settings/Roles and Permissions";

import Directory from "../pages/Settings/Directory";
import Report from "../pages/Analitics/Report/Report";
import ReportIndex from "../pages/Analitics/Report/ReportIndex";
import Hecras from "../pages/Directories/Hecras";
import Grafik from "../pages/Directories/Grafik";
import Languages from "../pages/Language/Languages";
import ABMK from "../pages/Directories/gdm/ABMK";
import Dam from "../pages/Directories/gdm/Dam";
import HidroTabs from "../pages/Directories/gdm/HidroTabs";

const authProtectedRoutes = [
  { path: "/directory", component: <Directory /> },
  { path: "/analytics/report", component: <ReportIndex /> },
  { path: "/analytics/report/:tab", component: <Report /> },
  { path: "/hecras", component: <Hecras /> },
  { path: "/графика", component: <Grafik /> },
  { path: "/lang", component: <Languages /> },
  // { path: "/abmk", component: <ABMK /> },
  { path: "/dam", component: <Dam /> },
  { path: "/dam/:tab", component: <HidroTabs /> },
